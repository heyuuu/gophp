...
// func NewPhpCliServerClient(server *PhpCliServer, sock core.PhpSocketT, addr *__struct__sockaddr, addr_len socklen_t, addr_str *byte, addr_str_len int, parser PhpHttpParser, request_read uint, current_header_name *byte, current_header_name_len int, current_header_name_allocated uint, current_header_value *byte, current_header_value_len int, last_header_element int, post_read_offset int, request PhpCliServerRequest, content_sender_initialized uint, content_sender PhpCliServerContentSender, file_fd int) *PhpCliServerClient {
//     return &PhpCliServerClient{
//         server:server,
//         sock:sock,
//         addr:addr,
//         addr_len:addr_len,
...
//         current_header_name:current_header_name,
//         current_header_name_len:current_header_name_len,
//         current_header_name_allocated:current_header_name_allocated,
//         current_header_value:current_header_value,
//         current_header_value_len:current_header_value_len,
//         last_header_element:last_header_element,
//         post_read_offset:post_read_offset,
//         request:request,
//         content_sender_initialized:content_sender_initialized,
//         content_sender:content_sender,
//         file_fd:file_fd,
//     }
// }
// func MakePhpCliServerClient(server *PhpCliServer, sock core.PhpSocketT, addr *__struct__sockaddr, addr_len socklen_t, addr_str *byte, addr_str_len int, parser PhpHttpParser, request_read uint, current_header_name *byte, current_header_name_len int, current_header_name_allocated uint, current_header_value *byte, current_header_value_len int, last_header_element int, post_read_offset int, request PhpCliServerRequest, content_sender_initialized uint, content_sender PhpCliServerContentSender, file_fd int) PhpCliServerClient {
//     return PhpCliServerClient{
//         server:server,
//         sock:sock,
//         addr:addr,
...
// func (this *PhpCliServerClient) SetContentSender(value PhpCliServerContentSender) { this.content_sender = value }
...
// func NewPhpCliServer(server_sock core.PhpSocketT, poller PhpCliServerPoller, is_running int, host *byte, port int, address_family int, document_root *byte, document_root_len int, router *byte, router_len int, socklen socklen_t, clients zend.HashTable, extension_mime_types zend.HashTable) *PhpCliServer {
//     return &PhpCliServer{
...
//         document_root_len:document_root_len,
//         router:router,
//         router_len:router_len,
//         socklen:socklen,
//         clients:clients,
//         extension_mime_types:extension_mime_types,
//     }
// }
// func MakePhpCliServer(server_sock core.PhpSocketT, poller PhpCliServerPoller, is_running int, host *byte, port int, address_family int, document_root *byte, document_root_len int, router *byte, router_len int, socklen socklen_t, clients zend.HashTable, extension_mime_types zend.HashTable) PhpCliServer {
//     return PhpCliServer{
//         server_sock:server_sock,
//         poller:poller,
//         is_running:is_running,
...
// func NewPhpCliServerDoEventForEachFdCallbackParams(server *PhpCliServer, rhandler func(*PhpCliServer, *PhpCliServerClient) int, whandler func(*PhpCliServer, *PhpCliServerClient) int) *PhpCliServerDoEventForEachFdCallbackParams {
...
// func (this *PhpCliServerDoEventForEachFdCallbackParams) SetServer(value *PhpCliServer) { this.server = value }
...
// func (this *PhpCliServerDoEventForEachFdCallbackParams) SetRhandler(value func(*PhpCliServer, *PhpCliServerClient) int) { this.rhandler = value }
...
// func (this *PhpCliServerDoEventForEachFdCallbackParams) SetWhandler(value func(*PhpCliServer, *PhpCliServerClient) int) { this.whandler = value }
