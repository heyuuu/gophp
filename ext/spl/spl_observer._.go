...
var spl_funcs_SplObserver []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_SplObserver_update")/b.SizeOf("struct _zend_internal_arg_info") - 1),
...
var spl_funcs_SplSubject []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_SplSubject_attach")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC | zend.ZEND_ACC_ABSTRACT,
	},
	{
		"detach",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_SplSubject_void")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC | zend.ZEND_ACC_ABSTRACT,
	},
	{nil, nil, nil, 0, 0},
}
...
var spl_funcs_SplObjectStorage []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		ArginfoAttach,
		uint32(b.SizeOf("arginfo_attach")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"detach",
		...
		arginfo_Object,
		uint32(b.SizeOf("arginfo_Object")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"contains",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_splobject_void")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"setInfo",
		...
		arginfo_setInfo,
		uint32(b.SizeOf("arginfo_setInfo")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"getHash",
		...
		arginfo_getHash,
		uint32(b.SizeOf("arginfo_getHash")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"__debugInfo",
	...
	},
	{
		...
		arginfo_Serialized,
		uint32(b.SizeOf("arginfo_Serialized")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"serialize",
	...
	},
	{
		...
		zim_spl_SplObjectStorage_contains,
		arginfo_offsetGet,
		uint32(b.SizeOf("arginfo_offsetGet")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"offsetSet",
...
var spl_funcs_MultipleIterator []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_MultipleIterator_setflags")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"getFlags",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_MultipleIterator_attachIterator")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"detachIterator",
		...
		uint32(b.SizeOf("arginfo_MultipleIterator_detachIterator")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"containsIterator",
		...
		uint32(b.SizeOf("arginfo_MultipleIterator_containsIterator")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		0,
	},
	{
		"countIterators",
