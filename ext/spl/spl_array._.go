...
var spl_funcs_ArrayObject []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_array___construct")/b.SizeOf("struct _zend_internal_arg_info") - 1),
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_offsetGet")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"offsetGet",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_offsetSet")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"offsetUnset",
	...
	},
	{
		...
		ArginfoArrayAppend,
		uint32(b.SizeOf("arginfo_array_append")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"getArrayCopy",
		...
		ArginfoArrayVoid,
		uint32(b.SizeOf("arginfo_array_void")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"count",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_setFlags")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"asort",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_uXsort")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"uksort",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_unserialize")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"serialize",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_array_exchangeArray")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"setIteratorClass",
		...
		uint32(b.SizeOf("arginfo_array_setIteratorClass")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"getIteratorClass",
...
var spl_funcs_ArrayIterator []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_array_iterator___construct")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"offsetExists",
	...
	},
	{
		...
		zim_spl_Array_seek,
		ArginfoArraySeek,
		uint32(b.SizeOf("arginfo_array_seek")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{nil, nil, nil, 0, 0},
}
