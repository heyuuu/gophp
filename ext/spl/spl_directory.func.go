...
func ZmStartupSplDirectory(type_ int, module_number int) int {
	spl_ce_SplFileInfo = zend.SplRegisterClass("SplFileInfo", SplFilesystemObjectNew, spl_SplFileInfo_functions)
	...
	spl_ce_DirectoryIterator = zend.SplRegisterSubClass(spl_ce_SplFileInfo, "DirectoryIterator", SplFilesystemObjectNew, spl_DirectoryIterator_functions)
	...
	spl_ce_FilesystemIterator = zend.SplRegisterSubClass(spl_ce_DirectoryIterator, "FilesystemIterator", SplFilesystemObjectNew, spl_FilesystemIterator_functions)
	...
	spl_ce_RecursiveDirectoryIterator = zend.SplRegisterSubClass(spl_ce_FilesystemIterator, "RecursiveDirectoryIterator", SplFilesystemObjectNew, spl_RecursiveDirectoryIterator_functions)
	...
	spl_ce_GlobIterator = zend.SplRegisterSubClass(spl_ce_FilesystemIterator, "GlobIterator", SplFilesystemObjectNewCheck, spl_GlobIterator_functions)
	zend.ZendClassImplements(spl_ce_GlobIterator, 1, spl_ce_Countable)
	spl_ce_SplFileObject = zend.SplRegisterSubClass(spl_ce_SplFileInfo, "SplFileObject", SplFilesystemObjectNewCheck, spl_SplFileObject_functions)
	...
	spl_ce_SplTempFileObject = zend.SplRegisterSubClass(spl_ce_SplFileObject, "SplTempFileObject", SplFilesystemObjectNewCheck, spl_SplTempFileObject_functions)
	return types.SUCCESS
}
