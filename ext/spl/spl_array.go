...
var spl_funcs_ArrayObject []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"__construct", zim_spl_Array___construct, ArginfoArrayConstruct, uint32(g.SizeOf("arginfo_array___construct")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetExists", zim_spl_Array_offsetExists, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetGet", zim_spl_Array_offsetGet, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetSet", zim_spl_Array_offsetSet, arginfo_array_offsetSet, uint32(g.SizeOf("arginfo_array_offsetSet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetUnset", zim_spl_Array_offsetUnset, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"append", zim_spl_Array_append, ArginfoArrayAppend, uint32(g.SizeOf("arginfo_array_append")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getArrayCopy", zim_spl_Array_getArrayCopy, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"count", zim_spl_Array_count, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getFlags", zim_spl_Array_getFlags, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"setFlags", zim_spl_Array_setFlags, arginfo_array_setFlags, uint32(g.SizeOf("arginfo_array_setFlags")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"asort", zim_spl_Array_asort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"ksort", zim_spl_Array_ksort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"uasort", zim_spl_Array_uasort, arginfo_array_uXsort, uint32(g.SizeOf("arginfo_array_uXsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"uksort", zim_spl_Array_uksort, arginfo_array_uXsort, uint32(g.SizeOf("arginfo_array_uXsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"natsort", zim_spl_Array_natsort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"natcasesort", zim_spl_Array_natcasesort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"unserialize", zim_spl_Array_unserialize, ArginfoArrayUnserialize, uint32(g.SizeOf("arginfo_array_unserialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"serialize", zim_spl_Array_serialize, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__unserialize", zim_spl_Array___unserialize, ArginfoArrayUnserialize, uint32(g.SizeOf("arginfo_array_unserialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__serialize", zim_spl_Array___serialize, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__debugInfo", zim_spl_Array___debugInfo, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getIterator", zim_spl_Array_getIterator, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"exchangeArray", zim_spl_Array_exchangeArray, arginfo_array_exchangeArray, uint32(g.SizeOf("arginfo_array_exchangeArray")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"setIteratorClass", zim_spl_Array_setIteratorClass, arginfo_array_setIteratorClass, uint32(g.SizeOf("arginfo_array_setIteratorClass")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getIteratorClass", zim_spl_Array_getIteratorClass, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {nil, nil, nil, 0, 0}}
var spl_funcs_ArrayIterator []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"__construct", zim_spl_ArrayIterator___construct, ArginfoArrayIteratorConstruct, uint32(g.SizeOf("arginfo_array_iterator___construct")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetExists", zim_spl_Array_offsetExists, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetGet", zim_spl_Array_offsetGet, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetSet", zim_spl_Array_offsetSet, arginfo_array_offsetSet, uint32(g.SizeOf("arginfo_array_offsetSet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetUnset", zim_spl_Array_offsetUnset, arginfo_array_offsetGet, uint32(g.SizeOf("arginfo_array_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"append", zim_spl_Array_append, ArginfoArrayAppend, uint32(g.SizeOf("arginfo_array_append")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getArrayCopy", zim_spl_Array_getArrayCopy, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"count", zim_spl_Array_count, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getFlags", zim_spl_Array_getFlags, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"setFlags", zim_spl_Array_setFlags, arginfo_array_setFlags, uint32(g.SizeOf("arginfo_array_setFlags")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"asort", zim_spl_Array_asort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"ksort", zim_spl_Array_ksort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"uasort", zim_spl_Array_uasort, arginfo_array_uXsort, uint32(g.SizeOf("arginfo_array_uXsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"uksort", zim_spl_Array_uksort, arginfo_array_uXsort, uint32(g.SizeOf("arginfo_array_uXsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"natsort", zim_spl_Array_natsort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"natcasesort", zim_spl_Array_natcasesort, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"unserialize", zim_spl_Array_unserialize, ArginfoArrayUnserialize, uint32(g.SizeOf("arginfo_array_unserialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"serialize", zim_spl_Array_serialize, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__unserialize", zim_spl_Array___unserialize, ArginfoArrayUnserialize, uint32(g.SizeOf("arginfo_array_unserialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__serialize", zim_spl_Array___serialize, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__debugInfo", zim_spl_Array___debugInfo, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"rewind", zim_spl_Array_rewind, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"current", zim_spl_Array_current, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"key", zim_spl_Array_key, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"next", zim_spl_Array_next, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"valid", zim_spl_Array_valid, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"seek", zim_spl_Array_seek, ArginfoArraySeek, uint32(g.SizeOf("arginfo_array_seek")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {nil, nil, nil, 0, 0}}
var spl_funcs_RecursiveArrayIterator []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"hasChildren", zim_spl_Array_hasChildren, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getChildren", zim_spl_Array_getChildren, ArginfoArrayVoid, uint32(g.SizeOf("arginfo_array_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {nil, nil, nil, 0, 0}}
