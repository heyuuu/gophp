...
func ZmStartupSplHeap(type_ int, module_number int) int {
	spl_ce_SplHeap = zend.SplRegisterClass("SplHeap", SplHeapObjectNew, spl_funcs_SplHeap)
	...
	spl_ce_SplMinHeap = zend.SplRegisterSubClass(spl_ce_SplHeap, "SplMinHeap", SplHeapObjectNew, spl_funcs_SplMinHeap)
	spl_ce_SplMaxHeap = zend.SplRegisterSubClass(spl_ce_SplHeap, "SplMaxHeap", SplHeapObjectNew, spl_funcs_SplMaxHeap)
	spl_ce_SplMaxHeap.SetGetIterator(SplHeapGetIterator)
	spl_ce_SplMinHeap.SetGetIterator(SplHeapGetIterator)
	spl_ce_SplPriorityQueue = zend.SplRegisterClass("SplPriorityQueue", SplHeapObjectNew, spl_funcs_SplPriorityQueue)
