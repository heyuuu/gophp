...
func (this *SplFilesystemObject) SetFuncRewind(value *zend.ZendFunction) {
	this.u.dir.func_rewind = value
}
...
func (this *SplFilesystemObject) SetFuncValid(value *zend.ZendFunction) {
	this.u.dir.func_valid = value
}
