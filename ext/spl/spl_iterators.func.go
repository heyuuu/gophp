...
func ZmStartupSplIterators(type_ int, module_number int) int {
	...
	spl_ce_RecursiveIteratorIterator = zend.SplRegisterClass("RecursiveIteratorIterator", spl_RecursiveIteratorIterator_new, spl_funcs_RecursiveIteratorIterator)
	...
	spl_ce_IteratorIterator = zend.SplRegisterClass("IteratorIterator", SplDualItNew, spl_funcs_IteratorIterator)
	...
	spl_ce_FilterIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "FilterIterator", SplDualItNew, spl_funcs_FilterIterator)
	spl_ce_FilterIterator.AddCeFlags(zend.AccExplicitAbstractClass)
	spl_ce_RecursiveFilterIterator = zend.SplRegisterSubClass(spl_ce_FilterIterator, "RecursiveFilterIterator", SplDualItNew, spl_funcs_RecursiveFilterIterator)
	zend.ZendClassImplements(spl_ce_RecursiveFilterIterator, 1, spl_ce_RecursiveIterator)
	spl_ce_CallbackFilterIterator = zend.SplRegisterSubClass(spl_ce_FilterIterator, "CallbackFilterIterator", SplDualItNew, spl_funcs_CallbackFilterIterator)
	spl_ce_RecursiveCallbackFilterIterator = zend.SplRegisterSubClass(spl_ce_CallbackFilterIterator, "RecursiveCallbackFilterIterator", SplDualItNew, spl_funcs_RecursiveCallbackFilterIterator)
	zend.ZendClassImplements(spl_ce_RecursiveCallbackFilterIterator, 1, spl_ce_RecursiveIterator)
	spl_ce_ParentIterator = zend.SplRegisterSubClass(spl_ce_RecursiveFilterIterator, "ParentIterator", SplDualItNew, spl_funcs_ParentIterator)
	...
	spl_ce_LimitIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "LimitIterator", SplDualItNew, spl_funcs_LimitIterator)
	spl_ce_CachingIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "CachingIterator", SplDualItNew, spl_funcs_CachingIterator)
	...
	spl_ce_RecursiveCachingIterator = zend.SplRegisterSubClass(spl_ce_CachingIterator, "RecursiveCachingIterator", SplDualItNew, spl_funcs_RecursiveCachingIterator)
	zend.ZendClassImplements(spl_ce_RecursiveCachingIterator, 1, spl_ce_RecursiveIterator)
	spl_ce_NoRewindIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "NoRewindIterator", SplDualItNew, spl_funcs_NoRewindIterator)
	spl_ce_AppendIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "AppendIterator", SplDualItNew, spl_funcs_AppendIterator)
	zend.ZendClassImplements(spl_ce_RecursiveIteratorIterator, 1, spl_ce_OuterIterator)
	spl_ce_InfiniteIterator = zend.SplRegisterSubClass(spl_ce_IteratorIterator, "InfiniteIterator", SplDualItNew, spl_funcs_InfiniteIterator)
	spl_ce_RegexIterator = zend.SplRegisterSubClass(spl_ce_FilterIterator, "RegexIterator", SplDualItNew, spl_funcs_RegexIterator)
	...
	spl_ce_RecursiveRegexIterator = zend.SplRegisterSubClass(spl_ce_RegexIterator, "RecursiveRegexIterator", SplDualItNew, spl_funcs_RecursiveRegexIterator)
	zend.ZendClassImplements(spl_ce_RecursiveRegexIterator, 1, spl_ce_RecursiveIterator)
	spl_ce_EmptyIterator = zend.SplRegisterClass("EmptyIterator", nil, spl_funcs_EmptyIterator)
	zend.ZendClassImplements(spl_ce_EmptyIterator, 1, zend.ZendCeIterator)
	spl_ce_RecursiveTreeIterator = zend.SplRegisterSubClass(spl_ce_RecursiveIteratorIterator, "RecursiveTreeIterator", spl_RecursiveTreeIterator_new, spl_funcs_RecursiveTreeIterator)
