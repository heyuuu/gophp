...
var spl_funcs_SplQueue []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"enqueue", zim_spl_SplDoublyLinkedList_push, ArginfoDllistPush, uint32(g.SizeOf("arginfo_dllist_push")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"dequeue", zim_spl_SplDoublyLinkedList_shift, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {nil, nil, nil, 0, 0}}
var spl_funcs_SplDoublyLinkedList []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"pop", zim_spl_SplDoublyLinkedList_pop, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"shift", zim_spl_SplDoublyLinkedList_shift, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"push", zim_spl_SplDoublyLinkedList_push, ArginfoDllistPush, uint32(g.SizeOf("arginfo_dllist_push")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"unshift", zim_spl_SplDoublyLinkedList_unshift, ArginfoDllistPush, uint32(g.SizeOf("arginfo_dllist_push")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"top", zim_spl_SplDoublyLinkedList_top, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"bottom", zim_spl_SplDoublyLinkedList_bottom, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"isEmpty", zim_spl_SplDoublyLinkedList_isEmpty, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"setIteratorMode", zim_spl_SplDoublyLinkedList_setIteratorMode, ArginfoDllistSetiteratormode, uint32(g.SizeOf("arginfo_dllist_setiteratormode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"getIteratorMode", zim_spl_SplDoublyLinkedList_getIteratorMode, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__debugInfo", zim_spl_SplDoublyLinkedList___debugInfo, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"count", zim_spl_SplDoublyLinkedList_count, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetExists", zim_spl_SplDoublyLinkedList_offsetExists, arginfo_dllist_offsetGet, uint32(g.SizeOf("arginfo_dllist_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetGet", zim_spl_SplDoublyLinkedList_offsetGet, arginfo_dllist_offsetGet, uint32(g.SizeOf("arginfo_dllist_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetSet", zim_spl_SplDoublyLinkedList_offsetSet, arginfo_dllist_offsetSet, uint32(g.SizeOf("arginfo_dllist_offsetSet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"offsetUnset", zim_spl_SplDoublyLinkedList_offsetUnset, arginfo_dllist_offsetGet, uint32(g.SizeOf("arginfo_dllist_offsetGet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"add", zim_spl_SplDoublyLinkedList_add, arginfo_dllist_offsetSet, uint32(g.SizeOf("arginfo_dllist_offsetSet")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"rewind", zim_spl_SplDoublyLinkedList_rewind, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"current", zim_spl_SplDoublyLinkedList_current, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"key", zim_spl_SplDoublyLinkedList_key, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"next", zim_spl_SplDoublyLinkedList_next, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"prev", zim_spl_SplDoublyLinkedList_prev, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"valid", zim_spl_SplDoublyLinkedList_valid, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"unserialize", zim_spl_SplDoublyLinkedList_unserialize, ArginfoDllistSerialized, uint32(g.SizeOf("arginfo_dllist_serialized")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"serialize", zim_spl_SplDoublyLinkedList_serialize, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__unserialize", zim_spl_SplDoublyLinkedList___unserialize, ArginfoDllistSerialized, uint32(g.SizeOf("arginfo_dllist_serialized")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {"__serialize", zim_spl_SplDoublyLinkedList___serialize, ArginfoDllistVoid, uint32(g.SizeOf("arginfo_dllist_void")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 0}, {nil, nil, nil, 0, 0}}
