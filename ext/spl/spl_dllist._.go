...
var spl_funcs_SplQueue []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		ArginfoDllistPush,
		uint32(b.SizeOf("arginfo_dllist_push")/b.SizeOf("struct _zend_internal_arg_info") - 1),
	...
	},
	{
		...
		ArginfoDllistVoid,
		uint32(b.SizeOf("arginfo_dllist_void")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{nil, nil, nil, 0, 0},
}
var spl_funcs_SplDoublyLinkedList []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_dllist_setiteratormode")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"getIteratorMode",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_dllist_offsetGet")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"offsetGet",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_dllist_offsetSet")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"offsetUnset",
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_dllist_serialized")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"serialize",
