...
var spl_funcs_SplMinHeap []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	{
		...
		ArginfoHeapCompare,
		uint32(b.SizeOf("arginfo_heap_compare")/b.SizeOf("struct _zend_internal_arg_info") - 1),
...
var spl_funcs_SplPriorityQueue []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	...
	},
	{
		...
		ArginfoPqueueInsert,
		uint32(b.SizeOf("arginfo_pqueue_insert")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"setExtractFlags",
		...
		uint32(b.SizeOf("arginfo_pqueue_setflags")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"getExtractFlags",
		...
		ArginfoSplheapVoid,
		uint32(b.SizeOf("arginfo_splheap_void")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"top",
...
var spl_funcs_SplHeap []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{
	...
	},
	{
		...
		ArginfoHeapInsert,
		uint32(b.SizeOf("arginfo_heap_insert")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		zend.ZEND_ACC_PUBLIC,
	},
	{
		"top",
