...
func ZmStartupImagetypes(type_ int, module_number int) int {
	zend.RegisterLongConstant("IMAGETYPE_GIF", IMAGE_FILETYPE_GIF, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JPEG", IMAGE_FILETYPE_JPEG, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_PNG", IMAGE_FILETYPE_PNG, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_SWF", IMAGE_FILETYPE_SWF, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_PSD", IMAGE_FILETYPE_PSD, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_BMP", IMAGE_FILETYPE_BMP, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_TIFF_II", IMAGE_FILETYPE_TIFF_II, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_TIFF_MM", IMAGE_FILETYPE_TIFF_MM, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JPC", IMAGE_FILETYPE_JPC, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JP2", IMAGE_FILETYPE_JP2, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JPX", IMAGE_FILETYPE_JPX, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JB2", IMAGE_FILETYPE_JB2, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_IFF", IMAGE_FILETYPE_IFF, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_WBMP", IMAGE_FILETYPE_WBMP, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_JPEG2000", IMAGE_FILETYPE_JPC, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_XBM", IMAGE_FILETYPE_XBM, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("IMAGETYPE_ICO", IMAGE_FILETYPE_ICO, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
...
func ZifImageTypeToMimeType(executeData zpp.Ex, return_value zpp.Ret, imagetype *types.Zval) {
	...
	return_value.SetString(b.CastStrAuto((*byte)(PhpImageTypeToMimeType(p_image_type))))
}
func ZifImageTypeToExtension(executeData zpp.Ex, return_value zpp.Ret, imagetype *types.Zval, _ zpp.Opt, includeDot *types.Zval) {
	...
	if imgext != nil {
		return_value.SetString(b.CastStrAuto(&imgext[!inc_dot]))
		return
	}
	return_value.SetFalse()
	return
