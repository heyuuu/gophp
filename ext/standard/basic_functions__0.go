...
var ArginfoDnsGetRecord []zend.ZendInternalArgInfo = []zend.ZendInternalArgInfo{{(*byte)(zend_uintptr_t(1)), 0, 0, 0}, {"hostname", 0, 0, 0}, {"type", 0, 0, 0}, {"authns", 7<<2 | g.Cond(true, 0x1, 0x0), 1, 0}, {"addtl", 7<<2 | g.Cond(true, 0x1, 0x0), 1, 0}, {"raw", 0, 0, 0}}
...
var BasicFunctions []zend.ZendFunctionEntry = []zend.ZendFunctionEntry{{"constant", ZifConstant, ArginfoConstant, uint32(g.SizeOf("arginfo_constant")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"bin2hex", ZifBin2hex, ArginfoBin2hex, uint32(g.SizeOf("arginfo_bin2hex")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hex2bin", ZifHex2bin, ArginfoHex2bin, uint32(g.SizeOf("arginfo_hex2bin")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sleep", ZifSleep, ArginfoSleep, uint32(g.SizeOf("arginfo_sleep")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"usleep", ZifUsleep, ArginfoUsleep, uint32(g.SizeOf("arginfo_usleep")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"time_nanosleep", ZifTimeNanosleep, ArginfoTimeNanosleep, uint32(g.SizeOf("arginfo_time_nanosleep")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"time_sleep_until", ZifTimeSleepUntil, ArginfoTimeSleepUntil, uint32(g.SizeOf("arginfo_time_sleep_until")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strptime", ZifStrptime, ArginfoStrptime, uint32(g.SizeOf("arginfo_strptime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"flush", ZifFlush, ArginfoFlush, uint32(g.SizeOf("arginfo_flush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"wordwrap", ZifWordwrap, ArginfoWordwrap, uint32(g.SizeOf("arginfo_wordwrap")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"htmlspecialchars", ZifHtmlspecialchars, ArginfoHtmlspecialchars, uint32(g.SizeOf("arginfo_htmlspecialchars")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"htmlentities", ZifHtmlentities, ArginfoHtmlentities, uint32(g.SizeOf("arginfo_htmlentities")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"html_entity_decode", ZifHtmlEntityDecode, ArginfoHtmlEntityDecode, uint32(g.SizeOf("arginfo_html_entity_decode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"htmlspecialchars_decode", ZifHtmlspecialcharsDecode, ArginfoHtmlspecialcharsDecode, uint32(g.SizeOf("arginfo_htmlspecialchars_decode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_html_translation_table", ZifGetHtmlTranslationTable, ArginfoGetHtmlTranslationTable, uint32(g.SizeOf("arginfo_get_html_translation_table")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sha1", ZifSha1, ArginfoSha1, uint32(g.SizeOf("arginfo_sha1")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sha1_file", ZifSha1File, ArginfoSha1File, uint32(g.SizeOf("arginfo_sha1_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"md5", PhpIfMd5, ArginfoMd5, uint32(g.SizeOf("arginfo_md5")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"md5_file", PhpIfMd5File, ArginfoMd5File, uint32(g.SizeOf("arginfo_md5_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"crc32", PhpIfCrc32, ArginfoCrc32, uint32(g.SizeOf("arginfo_crc32")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"iptcparse", ZifIptcparse, ArginfoIptcparse, uint32(g.SizeOf("arginfo_iptcparse")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"iptcembed", ZifIptcembed, ArginfoIptcembed, uint32(g.SizeOf("arginfo_iptcembed")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getimagesize", ZifGetimagesize, ArginfoGetimagesize, uint32(g.SizeOf("arginfo_getimagesize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getimagesizefromstring", ZifGetimagesizefromstring, ArginfoGetimagesize, uint32(g.SizeOf("arginfo_getimagesize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"image_type_to_mime_type", ZifImageTypeToMimeType, ArginfoImageTypeToMimeType, uint32(g.SizeOf("arginfo_image_type_to_mime_type")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"image_type_to_extension", ZifImageTypeToExtension, ArginfoImageTypeToExtension, uint32(g.SizeOf("arginfo_image_type_to_extension")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"phpinfo", ZifPhpinfo, ArginfoPhpinfo, uint32(g.SizeOf("arginfo_phpinfo")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"phpversion", ZifPhpversion, ArginfoPhpversion, uint32(g.SizeOf("arginfo_phpversion")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"phpcredits", ZifPhpcredits, ArginfoPhpcredits, uint32(g.SizeOf("arginfo_phpcredits")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"php_sapi_name", ZifPhpSapiName, ArginfoPhpSapiName, uint32(g.SizeOf("arginfo_php_sapi_name")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"php_uname", ZifPhpUname, ArginfoPhpUname, uint32(g.SizeOf("arginfo_php_uname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"php_ini_scanned_files", ZifPhpIniScannedFiles, ArginfoPhpIniScannedFiles, uint32(g.SizeOf("arginfo_php_ini_scanned_files")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"php_ini_loaded_file", ZifPhpIniLoadedFile, ArginfoPhpIniLoadedFile, uint32(g.SizeOf("arginfo_php_ini_loaded_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strnatcmp", ZifStrnatcmp, ArginfoStrnatcmp, uint32(g.SizeOf("arginfo_strnatcmp")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strnatcasecmp", ZifStrnatcasecmp, ArginfoStrnatcasecmp, uint32(g.SizeOf("arginfo_strnatcasecmp")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"substr_count", ZifSubstrCount, ArginfoSubstrCount, uint32(g.SizeOf("arginfo_substr_count")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strspn", ZifStrspn, ArginfoStrspn, uint32(g.SizeOf("arginfo_strspn")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strcspn", ZifStrcspn, ArginfoStrcspn, uint32(g.SizeOf("arginfo_strcspn")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strtok", ZifStrtok, ArginfoStrtok, uint32(g.SizeOf("arginfo_strtok")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strtoupper", ZifStrtoupper, ArginfoStrtoupper, uint32(g.SizeOf("arginfo_strtoupper")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strtolower", ZifStrtolower, ArginfoStrtolower, uint32(g.SizeOf("arginfo_strtolower")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strpos", ZifStrpos, ArginfoStrpos, uint32(g.SizeOf("arginfo_strpos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stripos", ZifStripos, ArginfoStripos, uint32(g.SizeOf("arginfo_stripos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strrpos", ZifStrrpos, ArginfoStrrpos, uint32(g.SizeOf("arginfo_strrpos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strripos", ZifStrripos, ArginfoStrripos, uint32(g.SizeOf("arginfo_strripos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strrev", ZifStrrev, ArginfoStrrev, uint32(g.SizeOf("arginfo_strrev")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hebrev", ZifHebrev, ArginfoHebrev, uint32(g.SizeOf("arginfo_hebrev")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hebrevc", ZifHebrevc, ArginfoHebrevc, uint32(g.SizeOf("arginfo_hebrevc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"nl2br", ZifNl2br, ArginfoNl2br, uint32(g.SizeOf("arginfo_nl2br")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"basename", ZifBasename, ArginfoBasename, uint32(g.SizeOf("arginfo_basename")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dirname", ZifDirname, ArginfoDirname, uint32(g.SizeOf("arginfo_dirname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pathinfo", ZifPathinfo, ArginfoPathinfo, uint32(g.SizeOf("arginfo_pathinfo")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stripslashes", ZifStripslashes, ArginfoStripslashes, uint32(g.SizeOf("arginfo_stripslashes")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stripcslashes", ZifStripcslashes, ArginfoStripcslashes, uint32(g.SizeOf("arginfo_stripcslashes")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strstr", ZifStrstr, ArginfoStrstr, uint32(g.SizeOf("arginfo_strstr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stristr", ZifStristr, ArginfoStristr, uint32(g.SizeOf("arginfo_stristr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strrchr", ZifStrrchr, ArginfoStrrchr, uint32(g.SizeOf("arginfo_strrchr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_shuffle", ZifStrShuffle, ArginfoStrShuffle, uint32(g.SizeOf("arginfo_str_shuffle")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_word_count", ZifStrWordCount, ArginfoStrWordCount, uint32(g.SizeOf("arginfo_str_word_count")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_split", ZifStrSplit, ArginfoStrSplit, uint32(g.SizeOf("arginfo_str_split")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strpbrk", ZifStrpbrk, ArginfoStrpbrk, uint32(g.SizeOf("arginfo_strpbrk")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"substr_compare", ZifSubstrCompare, ArginfoSubstrCompare, uint32(g.SizeOf("arginfo_substr_compare")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"utf8_encode", ZifUtf8Encode, ArginfoUtf8Encode, uint32(g.SizeOf("arginfo_utf8_encode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"utf8_decode", ZifUtf8Decode, ArginfoUtf8Decode, uint32(g.SizeOf("arginfo_utf8_decode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strcoll", ZifStrcoll, ArginfoStrcoll, uint32(g.SizeOf("arginfo_strcoll")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"money_format", ZifMoneyFormat, ArginfoMoneyFormat, uint32(g.SizeOf("arginfo_money_format")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"substr", ZifSubstr, ArginfoSubstr, uint32(g.SizeOf("arginfo_substr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"substr_replace", ZifSubstrReplace, ArginfoSubstrReplace, uint32(g.SizeOf("arginfo_substr_replace")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"quotemeta", ZifQuotemeta, ArginfoQuotemeta, uint32(g.SizeOf("arginfo_quotemeta")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ucfirst", ZifUcfirst, ArginfoUcfirst, uint32(g.SizeOf("arginfo_ucfirst")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"lcfirst", ZifLcfirst, ArginfoLcfirst, uint32(g.SizeOf("arginfo_lcfirst")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ucwords", ZifUcwords, ArginfoUcwords, uint32(g.SizeOf("arginfo_ucwords")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strtr", ZifStrtr, ArginfoStrtr, uint32(g.SizeOf("arginfo_strtr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"addslashes", ZifAddslashes, ArginfoAddslashes, uint32(g.SizeOf("arginfo_addslashes")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"addcslashes", ZifAddcslashes, ArginfoAddcslashes, uint32(g.SizeOf("arginfo_addcslashes")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rtrim", ZifRtrim, ArginfoRtrim, uint32(g.SizeOf("arginfo_rtrim")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_replace", ZifStrReplace, ArginfoStrReplace, uint32(g.SizeOf("arginfo_str_replace")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_ireplace", ZifStrIreplace, ArginfoStrIreplace, uint32(g.SizeOf("arginfo_str_ireplace")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_repeat", ZifStrRepeat, ArginfoStrRepeat, uint32(g.SizeOf("arginfo_str_repeat")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"count_chars", ZifCountChars, ArginfoCountChars, uint32(g.SizeOf("arginfo_count_chars")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chunk_split", ZifChunkSplit, ArginfoChunkSplit, uint32(g.SizeOf("arginfo_chunk_split")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"trim", ZifTrim, ArginfoTrim, uint32(g.SizeOf("arginfo_trim")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ltrim", ZifLtrim, ArginfoLtrim, uint32(g.SizeOf("arginfo_ltrim")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strip_tags", ZifStripTags, ArginfoStripTags, uint32(g.SizeOf("arginfo_strip_tags")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"similar_text", ZifSimilarText, ArginfoSimilarText, uint32(g.SizeOf("arginfo_similar_text")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"explode", ZifExplode, ArginfoExplode, uint32(g.SizeOf("arginfo_explode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"implode", ZifImplode, ArginfoImplode, uint32(g.SizeOf("arginfo_implode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"join", ZifImplode, ArginfoImplode, uint32(g.SizeOf("arginfo_implode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"setlocale", ZifSetlocale, ArginfoSetlocale, uint32(g.SizeOf("arginfo_setlocale")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"localeconv", ZifLocaleconv, ArginfoLocaleconv, uint32(g.SizeOf("arginfo_localeconv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"soundex", ZifSoundex, ArginfoSoundex, uint32(g.SizeOf("arginfo_soundex")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"levenshtein", ZifLevenshtein, ArginfoLevenshtein, uint32(g.SizeOf("arginfo_levenshtein")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chr", ZifChr, ArginfoChr, uint32(g.SizeOf("arginfo_chr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ord", ZifOrd, ArginfoOrd, uint32(g.SizeOf("arginfo_ord")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"parse_str", ZifParseStr, ArginfoParseStr, uint32(g.SizeOf("arginfo_parse_str")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_getcsv", ZifStrGetcsv, ArginfoStrGetcsv, uint32(g.SizeOf("arginfo_str_getcsv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_pad", ZifStrPad, ArginfoStrPad, uint32(g.SizeOf("arginfo_str_pad")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chop", ZifRtrim, ArginfoRtrim, uint32(g.SizeOf("arginfo_rtrim")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strchr", ZifStrstr, ArginfoStrstr, uint32(g.SizeOf("arginfo_strstr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sprintf", ZifUserSprintf, ArginfoSprintf, uint32(g.SizeOf("arginfo_sprintf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"printf", ZifUserPrintf, ArginfoPrintf, uint32(g.SizeOf("arginfo_printf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"vprintf", ZifVprintf, ArginfoVprintf, uint32(g.SizeOf("arginfo_vprintf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"vsprintf", ZifVsprintf, ArginfoVsprintf, uint32(g.SizeOf("arginfo_vsprintf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fprintf", ZifFprintf, ArginfoFprintf, uint32(g.SizeOf("arginfo_fprintf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"vfprintf", ZifVfprintf, ArginfoVfprintf, uint32(g.SizeOf("arginfo_vfprintf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sscanf", ZifSscanf, ArginfoSscanf, uint32(g.SizeOf("arginfo_sscanf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fscanf", ZifFscanf, ArginfoFscanf, uint32(g.SizeOf("arginfo_fscanf")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"parse_url", ZifParseUrl, ArginfoParseUrl, uint32(g.SizeOf("arginfo_parse_url")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"urlencode", ZifUrlencode, ArginfoUrlencode, uint32(g.SizeOf("arginfo_urlencode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"urldecode", ZifUrldecode, ArginfoUrldecode, uint32(g.SizeOf("arginfo_urldecode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rawurlencode", ZifRawurlencode, ArginfoRawurlencode, uint32(g.SizeOf("arginfo_rawurlencode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rawurldecode", ZifRawurldecode, ArginfoRawurldecode, uint32(g.SizeOf("arginfo_rawurldecode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"http_build_query", ZifHttpBuildQuery, ArginfoHttpBuildQuery, uint32(g.SizeOf("arginfo_http_build_query")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"readlink", ZifReadlink, ArginfoReadlink, uint32(g.SizeOf("arginfo_readlink")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"linkinfo", ZifLinkinfo, ArginfoLinkinfo, uint32(g.SizeOf("arginfo_linkinfo")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"symlink", ZifSymlink, ArginfoSymlink, uint32(g.SizeOf("arginfo_symlink")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"link", ZifLink, ArginfoLink, uint32(g.SizeOf("arginfo_link")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"unlink", ZifUnlink, ArginfoUnlink, uint32(g.SizeOf("arginfo_unlink")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"exec", ZifExec, ArginfoExec, uint32(g.SizeOf("arginfo_exec")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"system", ZifSystem, ArginfoSystem, uint32(g.SizeOf("arginfo_system")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"escapeshellcmd", ZifEscapeshellcmd, ArginfoEscapeshellcmd, uint32(g.SizeOf("arginfo_escapeshellcmd")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"escapeshellarg", ZifEscapeshellarg, ArginfoEscapeshellarg, uint32(g.SizeOf("arginfo_escapeshellarg")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"passthru", ZifPassthru, ArginfoPassthru, uint32(g.SizeOf("arginfo_passthru")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"shell_exec", ZifShellExec, ArginfoShellExec, uint32(g.SizeOf("arginfo_shell_exec")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"proc_open", ZifProcOpen, ArginfoProcOpen, uint32(g.SizeOf("arginfo_proc_open")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"proc_close", ZifProcClose, ArginfoProcClose, uint32(g.SizeOf("arginfo_proc_close")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"proc_terminate", ZifProcTerminate, ArginfoProcTerminate, uint32(g.SizeOf("arginfo_proc_terminate")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"proc_get_status", ZifProcGetStatus, ArginfoProcGetStatus, uint32(g.SizeOf("arginfo_proc_get_status")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"proc_nice", ZifProcNice, ArginfoProcNice, uint32(g.SizeOf("arginfo_proc_nice")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rand", ZifRand, ArginfoMtRand, uint32(g.SizeOf("arginfo_mt_rand")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"srand", ZifMtSrand, ArginfoMtSrand, uint32(g.SizeOf("arginfo_mt_srand")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getrandmax", ZifMtGetrandmax, ArginfoMtGetrandmax, uint32(g.SizeOf("arginfo_mt_getrandmax")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"mt_rand", ZifMtRand, ArginfoMtRand, uint32(g.SizeOf("arginfo_mt_rand")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"mt_srand", ZifMtSrand, ArginfoMtSrand, uint32(g.SizeOf("arginfo_mt_srand")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"mt_getrandmax", ZifMtGetrandmax, ArginfoMtGetrandmax, uint32(g.SizeOf("arginfo_mt_getrandmax")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"random_bytes", ZifRandomBytes, ArginfoRandomBytes, uint32(g.SizeOf("arginfo_random_bytes")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"random_int", ZifRandomInt, ArginfoRandomInt, uint32(g.SizeOf("arginfo_random_int")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getservbyname", ZifGetservbyname, ArginfoGetservbyname, uint32(g.SizeOf("arginfo_getservbyname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getservbyport", ZifGetservbyport, ArginfoGetservbyport, uint32(g.SizeOf("arginfo_getservbyport")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getprotobyname", ZifGetprotobyname, ArginfoGetprotobyname, uint32(g.SizeOf("arginfo_getprotobyname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getprotobynumber", ZifGetprotobynumber, ArginfoGetprotobynumber, uint32(g.SizeOf("arginfo_getprotobynumber")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getmyuid", ZifGetmyuid, ArginfoGetmyuid, uint32(g.SizeOf("arginfo_getmyuid")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getmygid", ZifGetmygid, ArginfoGetmygid, uint32(g.SizeOf("arginfo_getmygid")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getmypid", ZifGetmypid, ArginfoGetmypid, uint32(g.SizeOf("arginfo_getmypid")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getmyinode", ZifGetmyinode, ArginfoGetmyinode, uint32(g.SizeOf("arginfo_getmyinode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getlastmod", ZifGetlastmod, ArginfoGetlastmod, uint32(g.SizeOf("arginfo_getlastmod")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"base64_decode", ZifBase64Decode, ArginfoBase64Decode, uint32(g.SizeOf("arginfo_base64_decode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"base64_encode", ZifBase64Encode, ArginfoBase64Encode, uint32(g.SizeOf("arginfo_base64_encode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"password_hash", ZifPasswordHash, ArginfoPasswordHash, uint32(g.SizeOf("arginfo_password_hash")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"password_get_info", ZifPasswordGetInfo, ArginfoPasswordGetInfo, uint32(g.SizeOf("arginfo_password_get_info")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"password_needs_rehash", ZifPasswordNeedsRehash, ArginfoPasswordNeedsRehash, uint32(g.SizeOf("arginfo_password_needs_rehash")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"password_verify", ZifPasswordVerify, ArginfoPasswordVerify, uint32(g.SizeOf("arginfo_password_verify")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"password_algos", ZifPasswordAlgos, ArginfoPasswordAlgos, uint32(g.SizeOf("arginfo_password_algos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"convert_uuencode", ZifConvertUuencode, ArginfoConvertUuencode, uint32(g.SizeOf("arginfo_convert_uuencode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"convert_uudecode", ZifConvertUudecode, ArginfoConvertUudecode, uint32(g.SizeOf("arginfo_convert_uudecode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"abs", ZifAbs, ArginfoAbs, uint32(g.SizeOf("arginfo_abs")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ceil", ZifCeil, ArginfoCeil, uint32(g.SizeOf("arginfo_ceil")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"floor", ZifFloor, ArginfoFloor, uint32(g.SizeOf("arginfo_floor")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"round", ZifRound, ArginfoRound, uint32(g.SizeOf("arginfo_round")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sin", ZifSin, ArginfoSin, uint32(g.SizeOf("arginfo_sin")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"cos", ZifCos, ArginfoCos, uint32(g.SizeOf("arginfo_cos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"tan", ZifTan, ArginfoTan, uint32(g.SizeOf("arginfo_tan")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"asin", ZifAsin, ArginfoAsin, uint32(g.SizeOf("arginfo_asin")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"acos", ZifAcos, ArginfoAcos, uint32(g.SizeOf("arginfo_acos")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"atan", ZifAtan, ArginfoAtan, uint32(g.SizeOf("arginfo_atan")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"atanh", ZifAtanh, ArginfoAtanh, uint32(g.SizeOf("arginfo_atanh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"atan2", ZifAtan2, ArginfoAtan2, uint32(g.SizeOf("arginfo_atan2")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sinh", ZifSinh, ArginfoSinh, uint32(g.SizeOf("arginfo_sinh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"cosh", ZifCosh, ArginfoCosh, uint32(g.SizeOf("arginfo_cosh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"tanh", ZifTanh, ArginfoTanh, uint32(g.SizeOf("arginfo_tanh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"asinh", ZifAsinh, ArginfoAsinh, uint32(g.SizeOf("arginfo_asinh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"acosh", ZifAcosh, ArginfoAcosh, uint32(g.SizeOf("arginfo_acosh")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"expm1", ZifExpm1, ArginfoExpm1, uint32(g.SizeOf("arginfo_expm1")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"log1p", ZifLog1p, ArginfoLog1p, uint32(g.SizeOf("arginfo_log1p")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pi", ZifPi, ArginfoPi, uint32(g.SizeOf("arginfo_pi")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_finite", ZifIsFinite, ArginfoIsFinite, uint32(g.SizeOf("arginfo_is_finite")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_nan", ZifIsNan, ArginfoIsNan, uint32(g.SizeOf("arginfo_is_nan")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_infinite", ZifIsInfinite, ArginfoIsInfinite, uint32(g.SizeOf("arginfo_is_infinite")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pow", ZifPow, ArginfoPow, uint32(g.SizeOf("arginfo_pow")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"exp", ZifExp, ArginfoExp, uint32(g.SizeOf("arginfo_exp")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"log", ZifLog, ArginfoLog, uint32(g.SizeOf("arginfo_log")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"log10", ZifLog10, ArginfoLog10, uint32(g.SizeOf("arginfo_log10")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sqrt", ZifSqrt, ArginfoSqrt, uint32(g.SizeOf("arginfo_sqrt")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hypot", ZifHypot, ArginfoHypot, uint32(g.SizeOf("arginfo_hypot")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"deg2rad", ZifDeg2rad, ArginfoDeg2rad, uint32(g.SizeOf("arginfo_deg2rad")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rad2deg", ZifRad2deg, ArginfoRad2deg, uint32(g.SizeOf("arginfo_rad2deg")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"bindec", ZifBindec, ArginfoBindec, uint32(g.SizeOf("arginfo_bindec")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hexdec", ZifHexdec, ArginfoHexdec, uint32(g.SizeOf("arginfo_hexdec")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"octdec", ZifOctdec, ArginfoOctdec, uint32(g.SizeOf("arginfo_octdec")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"decbin", ZifDecbin, ArginfoDecbin, uint32(g.SizeOf("arginfo_decbin")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"decoct", ZifDecoct, ArginfoDecoct, uint32(g.SizeOf("arginfo_decoct")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dechex", ZifDechex, ArginfoDechex, uint32(g.SizeOf("arginfo_dechex")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"base_convert", ZifBaseConvert, ArginfoBaseConvert, uint32(g.SizeOf("arginfo_base_convert")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"number_format", ZifNumberFormat, ArginfoNumberFormat, uint32(g.SizeOf("arginfo_number_format")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fmod", ZifFmod, ArginfoFmod, uint32(g.SizeOf("arginfo_fmod")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"intdiv", ZifIntdiv, ArginfoIntdiv, uint32(g.SizeOf("arginfo_intdiv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"inet_ntop", ZifInetNtop, ArginfoInetNtop, uint32(g.SizeOf("arginfo_inet_ntop")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"inet_pton", PhpInetPton, ArginfoInetPton, uint32(g.SizeOf("arginfo_inet_pton")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ip2long", ZifIp2long, ArginfoIp2long, uint32(g.SizeOf("arginfo_ip2long")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"long2ip", ZifLong2ip, ArginfoLong2ip, uint32(g.SizeOf("arginfo_long2ip")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getenv", ZifGetenv, ArginfoGetenv, uint32(g.SizeOf("arginfo_getenv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"putenv", ZifPutenv, ArginfoPutenv, uint32(g.SizeOf("arginfo_putenv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getopt", ZifGetopt, ArginfoGetopt, uint32(g.SizeOf("arginfo_getopt")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sys_getloadavg", ZifSysGetloadavg, ArginfoSysGetloadavg, uint32(g.SizeOf("arginfo_sys_getloadavg")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"microtime", ZifMicrotime, ArginfoMicrotime, uint32(g.SizeOf("arginfo_microtime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gettimeofday", ZifGettimeofday, ArginfoGettimeofday, uint32(g.SizeOf("arginfo_gettimeofday")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getrusage", ZifGetrusage, ArginfoGetrusage, uint32(g.SizeOf("arginfo_getrusage")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"hrtime", ZifHrtime, ArginfoHrtime, uint32(g.SizeOf("arginfo_hrtime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"uniqid", ZifUniqid, ArginfoUniqid, uint32(g.SizeOf("arginfo_uniqid")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"quoted_printable_decode", ZifQuotedPrintableDecode, ArginfoQuotedPrintableDecode, uint32(g.SizeOf("arginfo_quoted_printable_decode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"quoted_printable_encode", ZifQuotedPrintableEncode, ArginfoQuotedPrintableEncode, uint32(g.SizeOf("arginfo_quoted_printable_encode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"convert_cyr_string", ZifConvertCyrString, ArginfoConvertCyrString, uint32(g.SizeOf("arginfo_convert_cyr_string")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"get_current_user", ZifGetCurrentUser, ArginfoGetCurrentUser, uint32(g.SizeOf("arginfo_get_current_user")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"set_time_limit", ZifSetTimeLimit, ArginfoSetTimeLimit, uint32(g.SizeOf("arginfo_set_time_limit")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"header_register_callback", ZifHeaderRegisterCallback, ArginfoHeaderRegisterCallback, uint32(g.SizeOf("arginfo_header_register_callback")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_cfg_var", ZifGetCfgVar, ArginfoGetCfgVar, uint32(g.SizeOf("arginfo_get_cfg_var")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_magic_quotes_gpc", ZifGetMagicQuotesGpc, ArginfoGetMagicQuotesGpc, uint32(g.SizeOf("arginfo_get_magic_quotes_gpc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"get_magic_quotes_runtime", ZifGetMagicQuotesRuntime, ArginfoGetMagicQuotesRuntime, uint32(g.SizeOf("arginfo_get_magic_quotes_runtime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"error_log", ZifErrorLog, ArginfoErrorLog, uint32(g.SizeOf("arginfo_error_log")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"error_get_last", ZifErrorGetLast, ArginfoErrorGetLast, uint32(g.SizeOf("arginfo_error_get_last")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"error_clear_last", ZifErrorClearLast, ArginfoErrorClearLast, uint32(g.SizeOf("arginfo_error_clear_last")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"call_user_func", ZifCallUserFunc, ArginfoCallUserFunc, uint32(g.SizeOf("arginfo_call_user_func")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"call_user_func_array", ZifCallUserFuncArray, ArginfoCallUserFuncArray, uint32(g.SizeOf("arginfo_call_user_func_array")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"forward_static_call", ZifForwardStaticCall, ArginfoForwardStaticCall, uint32(g.SizeOf("arginfo_forward_static_call")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"forward_static_call_array", ZifForwardStaticCallArray, ArginfoForwardStaticCallArray, uint32(g.SizeOf("arginfo_forward_static_call_array")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"serialize", ZifSerialize, ArginfoSerialize, uint32(g.SizeOf("arginfo_serialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"unserialize", ZifUnserialize, ArginfoUnserialize, uint32(g.SizeOf("arginfo_unserialize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"var_dump", ZifVarDump, ArginfoVarDump, uint32(g.SizeOf("arginfo_var_dump")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"var_export", ZifVarExport, ArginfoVarExport, uint32(g.SizeOf("arginfo_var_export")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"debug_zval_dump", ZifDebugZvalDump, ArginfoDebugZvalDump, uint32(g.SizeOf("arginfo_debug_zval_dump")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"print_r", ZifPrintR, ArginfoPrintR, uint32(g.SizeOf("arginfo_print_r")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"memory_get_usage", ZifMemoryGetUsage, ArginfoMemoryGetUsage, uint32(g.SizeOf("arginfo_memory_get_usage")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"memory_get_peak_usage", ZifMemoryGetPeakUsage, ArginfoMemoryGetPeakUsage, uint32(g.SizeOf("arginfo_memory_get_peak_usage")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"register_shutdown_function", ZifRegisterShutdownFunction, ArginfoRegisterShutdownFunction, uint32(g.SizeOf("arginfo_register_shutdown_function")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"register_tick_function", ZifRegisterTickFunction, ArginfoRegisterTickFunction, uint32(g.SizeOf("arginfo_register_tick_function")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"unregister_tick_function", ZifUnregisterTickFunction, ArginfoUnregisterTickFunction, uint32(g.SizeOf("arginfo_unregister_tick_function")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"highlight_file", ZifHighlightFile, ArginfoHighlightFile, uint32(g.SizeOf("arginfo_highlight_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"show_source", ZifHighlightFile, ArginfoHighlightFile, uint32(g.SizeOf("arginfo_highlight_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"highlight_string", ZifHighlightString, ArginfoHighlightString, uint32(g.SizeOf("arginfo_highlight_string")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"php_strip_whitespace", ZifPhpStripWhitespace, ArginfoPhpStripWhitespace, uint32(g.SizeOf("arginfo_php_strip_whitespace")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ini_get", ZifIniGet, ArginfoIniGet, uint32(g.SizeOf("arginfo_ini_get")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ini_get_all", ZifIniGetAll, ArginfoIniGetAll, uint32(g.SizeOf("arginfo_ini_get_all")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ini_set", ZifIniSet, ArginfoIniSet, uint32(g.SizeOf("arginfo_ini_set")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ini_alter", ZifIniSet, ArginfoIniSet, uint32(g.SizeOf("arginfo_ini_set")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ini_restore", ZifIniRestore, ArginfoIniRestore, uint32(g.SizeOf("arginfo_ini_restore")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_include_path", ZifGetIncludePath, ArginfoGetIncludePath, uint32(g.SizeOf("arginfo_get_include_path")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"set_include_path", ZifSetIncludePath, ArginfoSetIncludePath, uint32(g.SizeOf("arginfo_set_include_path")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"restore_include_path", ZifRestoreIncludePath, ArginfoRestoreIncludePath, uint32(g.SizeOf("arginfo_restore_include_path")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"setcookie", ZifSetcookie, ArginfoSetcookie, uint32(g.SizeOf("arginfo_setcookie")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"setrawcookie", ZifSetrawcookie, ArginfoSetrawcookie, uint32(g.SizeOf("arginfo_setrawcookie")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"header", ZifHeader, ArginfoHeader, uint32(g.SizeOf("arginfo_header")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"header_remove", ZifHeaderRemove, ArginfoHeaderRemove, uint32(g.SizeOf("arginfo_header_remove")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"headers_sent", ZifHeadersSent, ArginfoHeadersSent, uint32(g.SizeOf("arginfo_headers_sent")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"headers_list", ZifHeadersList, ArginfoHeadersList, uint32(g.SizeOf("arginfo_headers_list")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"http_response_code", ZifHttpResponseCode, ArginfoHttpResponseCode, uint32(g.SizeOf("arginfo_http_response_code")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"connection_aborted", ZifConnectionAborted, ArginfoConnectionAborted, uint32(g.SizeOf("arginfo_connection_aborted")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"connection_status", ZifConnectionStatus, ArginfoConnectionStatus, uint32(g.SizeOf("arginfo_connection_status")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ignore_user_abort", ZifIgnoreUserAbort, ArginfoIgnoreUserAbort, uint32(g.SizeOf("arginfo_ignore_user_abort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"parse_ini_file", ZifParseIniFile, ArginfoParseIniFile, uint32(g.SizeOf("arginfo_parse_ini_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"parse_ini_string", ZifParseIniString, ArginfoParseIniString, uint32(g.SizeOf("arginfo_parse_ini_string")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_uploaded_file", ZifIsUploadedFile, ArginfoIsUploadedFile, uint32(g.SizeOf("arginfo_is_uploaded_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"move_uploaded_file", ZifMoveUploadedFile, ArginfoMoveUploadedFile, uint32(g.SizeOf("arginfo_move_uploaded_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gethostbyaddr", ZifGethostbyaddr, ArginfoGethostbyaddr, uint32(g.SizeOf("arginfo_gethostbyaddr")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gethostbyname", ZifGethostbyname, ArginfoGethostbyname, uint32(g.SizeOf("arginfo_gethostbyname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gethostbynamel", ZifGethostbynamel, ArginfoGethostbynamel, uint32(g.SizeOf("arginfo_gethostbynamel")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gethostname", ZifGethostname, ArginfoGethostname, uint32(g.SizeOf("arginfo_gethostname")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"net_get_interfaces", ZifNetGetInterfaces, ArginfoNetGetInterfaces, uint32(g.SizeOf("arginfo_net_get_interfaces")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dns_check_record", ZifDnsCheckRecord, ArginfoDnsCheckRecord, uint32(g.SizeOf("arginfo_dns_check_record")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"checkdnsrr", ZifDnsCheckRecord, ArginfoDnsCheckRecord, uint32(g.SizeOf("arginfo_dns_check_record")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dns_get_mx", ZifDnsGetMx, ArginfoDnsGetMx, uint32(g.SizeOf("arginfo_dns_get_mx")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getmxrr", ZifDnsGetMx, ArginfoDnsGetMx, uint32(g.SizeOf("arginfo_dns_get_mx")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dns_get_record", ZifDnsGetRecord, ArginfoDnsGetRecord, uint32(g.SizeOf("arginfo_dns_get_record")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"intval", ZifIntval, ArginfoIntval, uint32(g.SizeOf("arginfo_intval")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"floatval", ZifFloatval, ArginfoFloatval, uint32(g.SizeOf("arginfo_floatval")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"doubleval", ZifFloatval, ArginfoFloatval, uint32(g.SizeOf("arginfo_floatval")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"strval", ZifStrval, ArginfoStrval, uint32(g.SizeOf("arginfo_strval")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"boolval", ZifBoolval, ArginfoBoolval, uint32(g.SizeOf("arginfo_boolval")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"gettype", ZifGettype, ArginfoGettype, uint32(g.SizeOf("arginfo_gettype")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"settype", ZifSettype, ArginfoSettype, uint32(g.SizeOf("arginfo_settype")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_null", ZifIsNull, ArginfoIsNull, uint32(g.SizeOf("arginfo_is_null")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_resource", ZifIsResource, ArginfoIsResource, uint32(g.SizeOf("arginfo_is_resource")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_bool", ZifIsBool, ArginfoIsBool, uint32(g.SizeOf("arginfo_is_bool")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_int", ZifIsInt, ArginfoIsInt, uint32(g.SizeOf("arginfo_is_int")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_float", ZifIsFloat, ArginfoIsFloat, uint32(g.SizeOf("arginfo_is_float")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_integer", ZifIsInt, ArginfoIsInt, uint32(g.SizeOf("arginfo_is_int")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_long", ZifIsInt, ArginfoIsInt, uint32(g.SizeOf("arginfo_is_int")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_double", ZifIsFloat, ArginfoIsFloat, uint32(g.SizeOf("arginfo_is_float")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_real", ZifIsFloat, ArginfoIsFloat, uint32(g.SizeOf("arginfo_is_float")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"is_numeric", ZifIsNumeric, ArginfoIsNumeric, uint32(g.SizeOf("arginfo_is_numeric")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_string", ZifIsString, ArginfoIsString, uint32(g.SizeOf("arginfo_is_string")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_array", ZifIsArray, ArginfoIsArray, uint32(g.SizeOf("arginfo_is_array")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_object", ZifIsObject, ArginfoIsObject, uint32(g.SizeOf("arginfo_is_object")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_scalar", ZifIsScalar, ArginfoIsScalar, uint32(g.SizeOf("arginfo_is_scalar")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_callable", ZifIsCallable, ArginfoIsCallable, uint32(g.SizeOf("arginfo_is_callable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_iterable", ZifIsIterable, ArginfoIsIterable, uint32(g.SizeOf("arginfo_is_iterable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_countable", ZifIsCountable, ArginfoIsCountable, uint32(g.SizeOf("arginfo_is_countable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pclose", ZifPclose, ArginfoPclose, uint32(g.SizeOf("arginfo_pclose")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"popen", ZifPopen, ArginfoPopen, uint32(g.SizeOf("arginfo_popen")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"readfile", ZifReadfile, ArginfoReadfile, uint32(g.SizeOf("arginfo_readfile")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rewind", ZifRewind, ArginfoRewind, uint32(g.SizeOf("arginfo_rewind")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rmdir", ZifRmdir, ArginfoRmdir, uint32(g.SizeOf("arginfo_rmdir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"umask", ZifUmask, ArginfoUmask, uint32(g.SizeOf("arginfo_umask")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fclose", ZifFclose, ArginfoFclose, uint32(g.SizeOf("arginfo_fclose")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"feof", ZifFeof, ArginfoFeof, uint32(g.SizeOf("arginfo_feof")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fgetc", ZifFgetc, ArginfoFgetc, uint32(g.SizeOf("arginfo_fgetc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fgets", ZifFgets, ArginfoFgets, uint32(g.SizeOf("arginfo_fgets")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fgetss", ZifFgetss, ArginfoFgetss, uint32(g.SizeOf("arginfo_fgetss")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"fread", ZifFread, ArginfoFread, uint32(g.SizeOf("arginfo_fread")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fopen", PhpIfFopen, ArginfoFopen, uint32(g.SizeOf("arginfo_fopen")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fpassthru", ZifFpassthru, ArginfoFpassthru, uint32(g.SizeOf("arginfo_fpassthru")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ftruncate", PhpIfFtruncate, ArginfoFtruncate, uint32(g.SizeOf("arginfo_ftruncate")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fstat", PhpIfFstat, ArginfoFstat, uint32(g.SizeOf("arginfo_fstat")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fseek", ZifFseek, ArginfoFseek, uint32(g.SizeOf("arginfo_fseek")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ftell", ZifFtell, ArginfoFtell, uint32(g.SizeOf("arginfo_ftell")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fflush", ZifFflush, ArginfoFflush, uint32(g.SizeOf("arginfo_fflush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fwrite", ZifFwrite, ArginfoFwrite, uint32(g.SizeOf("arginfo_fwrite")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fputs", ZifFwrite, ArginfoFwrite, uint32(g.SizeOf("arginfo_fwrite")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"mkdir", ZifMkdir, ArginfoMkdir, uint32(g.SizeOf("arginfo_mkdir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rename", ZifRename, ArginfoRename, uint32(g.SizeOf("arginfo_rename")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"copy", ZifCopy, ArginfoCopy, uint32(g.SizeOf("arginfo_copy")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"tempnam", ZifTempnam, ArginfoTempnam, uint32(g.SizeOf("arginfo_tempnam")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"tmpfile", PhpIfTmpfile, ArginfoTmpfile, uint32(g.SizeOf("arginfo_tmpfile")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"file", ZifFile, ArginfoFile, uint32(g.SizeOf("arginfo_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"file_get_contents", ZifFileGetContents, ArginfoFileGetContents, uint32(g.SizeOf("arginfo_file_get_contents")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"file_put_contents", ZifFilePutContents, ArginfoFilePutContents, uint32(g.SizeOf("arginfo_file_put_contents")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_select", ZifStreamSelect, ArginfoStreamSelect, uint32(g.SizeOf("arginfo_stream_select")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_create", ZifStreamContextCreate, ArginfoStreamContextCreate, uint32(g.SizeOf("arginfo_stream_context_create")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_set_params", ZifStreamContextSetParams, ArginfoStreamContextSetParams, uint32(g.SizeOf("arginfo_stream_context_set_params")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_get_params", ZifStreamContextGetParams, ArginfoStreamContextGetParams, uint32(g.SizeOf("arginfo_stream_context_get_params")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_set_option", ZifStreamContextSetOption, ArginfoStreamContextSetOption, uint32(g.SizeOf("arginfo_stream_context_set_option")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_get_options", ZifStreamContextGetOptions, ArginfoStreamContextGetOptions, uint32(g.SizeOf("arginfo_stream_context_get_options")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_get_default", ZifStreamContextGetDefault, ArginfoStreamContextGetDefault, uint32(g.SizeOf("arginfo_stream_context_get_default")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_context_set_default", ZifStreamContextSetDefault, ArginfoStreamContextSetDefault, uint32(g.SizeOf("arginfo_stream_context_set_default")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_filter_prepend", ZifStreamFilterPrepend, ArginfoStreamFilterPrepend, uint32(g.SizeOf("arginfo_stream_filter_prepend")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_filter_append", ZifStreamFilterAppend, ArginfoStreamFilterAppend, uint32(g.SizeOf("arginfo_stream_filter_append")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_filter_remove", ZifStreamFilterRemove, ArginfoStreamFilterRemove, uint32(g.SizeOf("arginfo_stream_filter_remove")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_client", ZifStreamSocketClient, ArginfoStreamSocketClient, uint32(g.SizeOf("arginfo_stream_socket_client")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_server", ZifStreamSocketServer, ArginfoStreamSocketServer, uint32(g.SizeOf("arginfo_stream_socket_server")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_accept", ZifStreamSocketAccept, ArginfoStreamSocketAccept, uint32(g.SizeOf("arginfo_stream_socket_accept")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_get_name", ZifStreamSocketGetName, ArginfoStreamSocketGetName, uint32(g.SizeOf("arginfo_stream_socket_get_name")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_recvfrom", ZifStreamSocketRecvfrom, ArginfoStreamSocketRecvfrom, uint32(g.SizeOf("arginfo_stream_socket_recvfrom")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_sendto", ZifStreamSocketSendto, ArginfoStreamSocketSendto, uint32(g.SizeOf("arginfo_stream_socket_sendto")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_enable_crypto", ZifStreamSocketEnableCrypto, ArginfoStreamSocketEnableCrypto, uint32(g.SizeOf("arginfo_stream_socket_enable_crypto")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_shutdown", ZifStreamSocketShutdown, ArginfoStreamSocketShutdown, uint32(g.SizeOf("arginfo_stream_socket_shutdown")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_socket_pair", ZifStreamSocketPair, ArginfoStreamSocketPair, uint32(g.SizeOf("arginfo_stream_socket_pair")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_copy_to_stream", ZifStreamCopyToStream, ArginfoStreamCopyToStream, uint32(g.SizeOf("arginfo_stream_copy_to_stream")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_contents", ZifStreamGetContents, ArginfoStreamGetContents, uint32(g.SizeOf("arginfo_stream_get_contents")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_supports_lock", ZifStreamSupportsLock, ArginfoStreamSupportsLock, uint32(g.SizeOf("arginfo_stream_supports_lock")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_isatty", ZifStreamIsatty, ArginfoStreamIsatty, uint32(g.SizeOf("arginfo_stream_isatty")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fgetcsv", ZifFgetcsv, ArginfoFgetcsv, uint32(g.SizeOf("arginfo_fgetcsv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fputcsv", ZifFputcsv, ArginfoFputcsv, uint32(g.SizeOf("arginfo_fputcsv")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"flock", ZifFlock, ArginfoFlock, uint32(g.SizeOf("arginfo_flock")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_meta_tags", ZifGetMetaTags, ArginfoGetMetaTags, uint32(g.SizeOf("arginfo_get_meta_tags")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_set_read_buffer", ZifStreamSetReadBuffer, ArginfoStreamSetReadBuffer, uint32(g.SizeOf("arginfo_stream_set_read_buffer")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_set_write_buffer", ZifStreamSetWriteBuffer, ArginfoStreamSetWriteBuffer, uint32(g.SizeOf("arginfo_stream_set_write_buffer")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"set_file_buffer", ZifStreamSetWriteBuffer, ArginfoStreamSetWriteBuffer, uint32(g.SizeOf("arginfo_stream_set_write_buffer")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_set_chunk_size", ZifStreamSetChunkSize, ArginfoStreamSetChunkSize, uint32(g.SizeOf("arginfo_stream_set_chunk_size")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_set_blocking", ZifStreamSetBlocking, ArginfoStreamSetBlocking, uint32(g.SizeOf("arginfo_stream_set_blocking")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"socket_set_blocking", ZifStreamSetBlocking, ArginfoStreamSetBlocking, uint32(g.SizeOf("arginfo_stream_set_blocking")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_meta_data", ZifStreamGetMetaData, ArginfoStreamGetMetaData, uint32(g.SizeOf("arginfo_stream_get_meta_data")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_line", ZifStreamGetLine, ArginfoStreamGetLine, uint32(g.SizeOf("arginfo_stream_get_line")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_wrapper_register", ZifStreamWrapperRegister, ArginfoStreamWrapperRegister, uint32(g.SizeOf("arginfo_stream_wrapper_register")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_register_wrapper", ZifStreamWrapperRegister, ArginfoStreamWrapperRegister, uint32(g.SizeOf("arginfo_stream_wrapper_register")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_wrapper_unregister", ZifStreamWrapperUnregister, ArginfoStreamWrapperUnregister, uint32(g.SizeOf("arginfo_stream_wrapper_unregister")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_wrapper_restore", ZifStreamWrapperRestore, ArginfoStreamWrapperRestore, uint32(g.SizeOf("arginfo_stream_wrapper_restore")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_wrappers", ZifStreamGetWrappers, ArginfoStreamGetWrappers, uint32(g.SizeOf("arginfo_stream_get_wrappers")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_transports", ZifStreamGetTransports, ArginfoStreamGetTransports, uint32(g.SizeOf("arginfo_stream_get_transports")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_resolve_include_path", ZifStreamResolveIncludePath, ArginfoStreamResolveIncludePath, uint32(g.SizeOf("arginfo_stream_resolve_include_path")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_is_local", ZifStreamIsLocal, ArginfoStreamIsLocal, uint32(g.SizeOf("arginfo_stream_is_local")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_headers", ZifGetHeaders, ArginfoGetHeaders, uint32(g.SizeOf("arginfo_get_headers")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_set_timeout", ZifStreamSetTimeout, ArginfoStreamSetTimeout, uint32(g.SizeOf("arginfo_stream_set_timeout")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"socket_set_timeout", ZifStreamSetTimeout, ArginfoStreamSetTimeout, uint32(g.SizeOf("arginfo_stream_set_timeout")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"socket_get_status", ZifStreamGetMetaData, ArginfoStreamGetMetaData, uint32(g.SizeOf("arginfo_stream_get_meta_data")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"realpath", ZifRealpath, ArginfoRealpath, uint32(g.SizeOf("arginfo_realpath")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fnmatch", ZifFnmatch, ArginfoFnmatch, uint32(g.SizeOf("arginfo_fnmatch")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fsockopen", ZifFsockopen, ArginfoFsockopen, uint32(g.SizeOf("arginfo_fsockopen")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pfsockopen", ZifPfsockopen, ArginfoPfsockopen, uint32(g.SizeOf("arginfo_pfsockopen")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pack", ZifPack, ArginfoPack, uint32(g.SizeOf("arginfo_pack")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"unpack", ZifUnpack, ArginfoUnpack, uint32(g.SizeOf("arginfo_unpack")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"get_browser", ZifGetBrowser, ArginfoGetBrowser, uint32(g.SizeOf("arginfo_get_browser")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"crypt", ZifCrypt, ArginfoCrypt, uint32(g.SizeOf("arginfo_crypt")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"opendir", ZifOpendir, ArginfoOpendir, uint32(g.SizeOf("arginfo_opendir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"closedir", ZifClosedir, ArginfoClosedir, uint32(g.SizeOf("arginfo_closedir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chdir", ZifChdir, ArginfoChdir, uint32(g.SizeOf("arginfo_chdir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chroot", ZifChroot, ArginfoChroot, uint32(g.SizeOf("arginfo_chroot")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"getcwd", ZifGetcwd, ArginfoGetcwd, uint32(g.SizeOf("arginfo_getcwd")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rewinddir", ZifRewinddir, ArginfoRewinddir, uint32(g.SizeOf("arginfo_rewinddir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"readdir", PhpIfReaddir, ArginfoReaddir, uint32(g.SizeOf("arginfo_readdir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"dir", ZifGetdir, ArginfoDir, uint32(g.SizeOf("arginfo_dir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"scandir", ZifScandir, ArginfoScandir, uint32(g.SizeOf("arginfo_scandir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"glob", ZifGlob, ArginfoGlob, uint32(g.SizeOf("arginfo_glob")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fileatime", ZifFileatime, ArginfoFileatime, uint32(g.SizeOf("arginfo_fileatime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"filectime", ZifFilectime, ArginfoFilectime, uint32(g.SizeOf("arginfo_filectime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"filegroup", ZifFilegroup, ArginfoFilegroup, uint32(g.SizeOf("arginfo_filegroup")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fileinode", ZifFileinode, ArginfoFileinode, uint32(g.SizeOf("arginfo_fileinode")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"filemtime", ZifFilemtime, ArginfoFilemtime, uint32(g.SizeOf("arginfo_filemtime")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fileowner", ZifFileowner, ArginfoFileowner, uint32(g.SizeOf("arginfo_fileowner")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"fileperms", ZifFileperms, ArginfoFileperms, uint32(g.SizeOf("arginfo_fileperms")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"filesize", ZifFilesize, ArginfoFilesize, uint32(g.SizeOf("arginfo_filesize")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"filetype", ZifFiletype, ArginfoFiletype, uint32(g.SizeOf("arginfo_filetype")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"file_exists", ZifFileExists, ArginfoFileExists, uint32(g.SizeOf("arginfo_file_exists")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_writable", ZifIsWritable, ArginfoIsWritable, uint32(g.SizeOf("arginfo_is_writable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_writeable", ZifIsWritable, ArginfoIsWritable, uint32(g.SizeOf("arginfo_is_writable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_readable", ZifIsReadable, ArginfoIsReadable, uint32(g.SizeOf("arginfo_is_readable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_executable", ZifIsExecutable, ArginfoIsExecutable, uint32(g.SizeOf("arginfo_is_executable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_file", ZifIsFile, ArginfoIsFile, uint32(g.SizeOf("arginfo_is_file")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_dir", ZifIsDir, ArginfoIsDir, uint32(g.SizeOf("arginfo_is_dir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"is_link", ZifIsLink, ArginfoIsLink, uint32(g.SizeOf("arginfo_is_link")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stat", PhpIfStat, ArginfoStat, uint32(g.SizeOf("arginfo_stat")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"lstat", PhpIfLstat, ArginfoLstat, uint32(g.SizeOf("arginfo_lstat")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chown", ZifChown, ArginfoChown, uint32(g.SizeOf("arginfo_chown")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chgrp", ZifChgrp, ArginfoChgrp, uint32(g.SizeOf("arginfo_chgrp")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"lchown", ZifLchown, ArginfoLchown, uint32(g.SizeOf("arginfo_lchown")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"lchgrp", ZifLchgrp, ArginfoLchgrp, uint32(g.SizeOf("arginfo_lchgrp")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"chmod", ZifChmod, ArginfoChmod, uint32(g.SizeOf("arginfo_chmod")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"touch", ZifTouch, ArginfoTouch, uint32(g.SizeOf("arginfo_touch")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"clearstatcache", ZifClearstatcache, ArginfoClearstatcache, uint32(g.SizeOf("arginfo_clearstatcache")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"disk_total_space", ZifDiskTotalSpace, ArginfoDiskTotalSpace, uint32(g.SizeOf("arginfo_disk_total_space")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"disk_free_space", ZifDiskFreeSpace, ArginfoDiskFreeSpace, uint32(g.SizeOf("arginfo_disk_free_space")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"diskfreespace", ZifDiskFreeSpace, ArginfoDiskFreeSpace, uint32(g.SizeOf("arginfo_disk_free_space")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"realpath_cache_size", ZifRealpathCacheSize, ArginfoRealpathCacheSize, uint32(g.SizeOf("arginfo_realpath_cache_size")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"realpath_cache_get", ZifRealpathCacheGet, ArginfoRealpathCacheGet, uint32(g.SizeOf("arginfo_realpath_cache_get")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"mail", ZifMail, ArginfoMail, uint32(g.SizeOf("arginfo_mail")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ezmlm_hash", ZifEzmlmHash, ArginfoEzmlmHash, uint32(g.SizeOf("arginfo_ezmlm_hash")/g.SizeOf("struct _zend_internal_arg_info") - 1), 1 << 11}, {"openlog", ZifOpenlog, ArginfoOpenlog, uint32(g.SizeOf("arginfo_openlog")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"syslog", ZifSyslog, ArginfoSyslog, uint32(g.SizeOf("arginfo_syslog")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"closelog", ZifCloselog, ArginfoCloselog, uint32(g.SizeOf("arginfo_closelog")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"lcg_value", ZifLcgValue, ArginfoLcgValue, uint32(g.SizeOf("arginfo_lcg_value")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"metaphone", ZifMetaphone, ArginfoMetaphone, uint32(g.SizeOf("arginfo_metaphone")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_start", core.ZifObStart, ArginfoObStart, uint32(g.SizeOf("arginfo_ob_start")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_flush", core.ZifObFlush, ArginfoObFlush, uint32(g.SizeOf("arginfo_ob_flush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_clean", core.ZifObClean, ArginfoObClean, uint32(g.SizeOf("arginfo_ob_clean")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_end_flush", core.ZifObEndFlush, ArginfoObEndFlush, uint32(g.SizeOf("arginfo_ob_end_flush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_end_clean", core.ZifObEndClean, ArginfoObEndClean, uint32(g.SizeOf("arginfo_ob_end_clean")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_flush", core.ZifObGetFlush, ArginfoObGetFlush, uint32(g.SizeOf("arginfo_ob_get_flush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_clean", core.ZifObGetClean, ArginfoObGetClean, uint32(g.SizeOf("arginfo_ob_get_clean")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_length", core.ZifObGetLength, ArginfoObGetLength, uint32(g.SizeOf("arginfo_ob_get_length")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_level", core.ZifObGetLevel, ArginfoObGetLevel, uint32(g.SizeOf("arginfo_ob_get_level")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_status", core.ZifObGetStatus, ArginfoObGetStatus, uint32(g.SizeOf("arginfo_ob_get_status")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_get_contents", core.ZifObGetContents, ArginfoObGetContents, uint32(g.SizeOf("arginfo_ob_get_contents")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_implicit_flush", core.ZifObImplicitFlush, ArginfoObImplicitFlush, uint32(g.SizeOf("arginfo_ob_implicit_flush")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ob_list_handlers", core.ZifObListHandlers, ArginfoObListHandlers, uint32(g.SizeOf("arginfo_ob_list_handlers")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ksort", ZifKsort, ArginfoKsort, uint32(g.SizeOf("arginfo_ksort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"krsort", ZifKrsort, ArginfoKrsort, uint32(g.SizeOf("arginfo_krsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"natsort", ZifNatsort, ArginfoNatsort, uint32(g.SizeOf("arginfo_natsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"natcasesort", ZifNatcasesort, ArginfoNatcasesort, uint32(g.SizeOf("arginfo_natcasesort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"asort", ZifAsort, ArginfoAsort, uint32(g.SizeOf("arginfo_asort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"arsort", ZifArsort, ArginfoArsort, uint32(g.SizeOf("arginfo_arsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sort", ZifSort, ArginfoSort, uint32(g.SizeOf("arginfo_sort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"rsort", ZifRsort, ArginfoRsort, uint32(g.SizeOf("arginfo_rsort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"usort", ZifUsort, ArginfoUsort, uint32(g.SizeOf("arginfo_usort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"uasort", ZifUasort, ArginfoUasort, uint32(g.SizeOf("arginfo_uasort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"uksort", ZifUksort, ArginfoUksort, uint32(g.SizeOf("arginfo_uksort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"shuffle", ZifShuffle, ArginfoShuffle, uint32(g.SizeOf("arginfo_shuffle")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_walk", ZifArrayWalk, ArginfoArrayWalk, uint32(g.SizeOf("arginfo_array_walk")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_walk_recursive", ZifArrayWalkRecursive, ArginfoArrayWalkRecursive, uint32(g.SizeOf("arginfo_array_walk_recursive")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"count", ZifCount, ArginfoCount, uint32(g.SizeOf("arginfo_count")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"end", ZifEnd, ArginfoEnd, uint32(g.SizeOf("arginfo_end")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"prev", ZifPrev, ArginfoPrev, uint32(g.SizeOf("arginfo_prev")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"next", ZifNext, ArginfoNext, uint32(g.SizeOf("arginfo_next")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"reset", ZifReset, ArginfoReset, uint32(g.SizeOf("arginfo_reset")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"current", ZifCurrent, ArginfoCurrent, uint32(g.SizeOf("arginfo_current")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"key", ZifKey, ArginfoKey, uint32(g.SizeOf("arginfo_key")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"min", ZifMin, ArginfoMin, uint32(g.SizeOf("arginfo_min")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"max", ZifMax, ArginfoMax, uint32(g.SizeOf("arginfo_max")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"in_array", ZifInArray, ArginfoInArray, uint32(g.SizeOf("arginfo_in_array")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_search", ZifArraySearch, ArginfoArraySearch, uint32(g.SizeOf("arginfo_array_search")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"extract", ZifExtract, ArginfoExtract, uint32(g.SizeOf("arginfo_extract")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"compact", ZifCompact, ArginfoCompact, uint32(g.SizeOf("arginfo_compact")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_fill", ZifArrayFill, ArginfoArrayFill, uint32(g.SizeOf("arginfo_array_fill")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_fill_keys", ZifArrayFillKeys, ArginfoArrayFillKeys, uint32(g.SizeOf("arginfo_array_fill_keys")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"range", ZifRange, ArginfoRange, uint32(g.SizeOf("arginfo_range")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_multisort", ZifArrayMultisort, ArginfoArrayMultisort, uint32(g.SizeOf("arginfo_array_multisort")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_push", ZifArrayPush, ArginfoArrayPush, uint32(g.SizeOf("arginfo_array_push")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_pop", ZifArrayPop, ArginfoArrayPop, uint32(g.SizeOf("arginfo_array_pop")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_shift", ZifArrayShift, ArginfoArrayShift, uint32(g.SizeOf("arginfo_array_shift")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_unshift", ZifArrayUnshift, ArginfoArrayUnshift, uint32(g.SizeOf("arginfo_array_unshift")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_splice", ZifArraySplice, ArginfoArraySplice, uint32(g.SizeOf("arginfo_array_splice")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_slice", ZifArraySlice, ArginfoArraySlice, uint32(g.SizeOf("arginfo_array_slice")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_merge", ZifArrayMerge, ArginfoArrayMerge, uint32(g.SizeOf("arginfo_array_merge")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_merge_recursive", ZifArrayMergeRecursive, ArginfoArrayMergeRecursive, uint32(g.SizeOf("arginfo_array_merge_recursive")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_replace", ZifArrayReplace, ArginfoArrayReplace, uint32(g.SizeOf("arginfo_array_replace")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_replace_recursive", ZifArrayReplaceRecursive, ArginfoArrayReplaceRecursive, uint32(g.SizeOf("arginfo_array_replace_recursive")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_keys", ZifArrayKeys, ArginfoArrayKeys, uint32(g.SizeOf("arginfo_array_keys")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_key_first", ZifArrayKeyFirst, ArginfoArrayKeyFirst, uint32(g.SizeOf("arginfo_array_key_first")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_key_last", ZifArrayKeyLast, ArginfoArrayKeyLast, uint32(g.SizeOf("arginfo_array_key_last")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_values", ZifArrayValues, ArginfoArrayValues, uint32(g.SizeOf("arginfo_array_values")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_count_values", ZifArrayCountValues, ArginfoArrayCountValues, uint32(g.SizeOf("arginfo_array_count_values")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_column", ZifArrayColumn, ArginfoArrayColumn, uint32(g.SizeOf("arginfo_array_column")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_reverse", ZifArrayReverse, ArginfoArrayReverse, uint32(g.SizeOf("arginfo_array_reverse")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_reduce", ZifArrayReduce, ArginfoArrayReduce, uint32(g.SizeOf("arginfo_array_reduce")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_pad", ZifArrayPad, ArginfoArrayPad, uint32(g.SizeOf("arginfo_array_pad")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_flip", ZifArrayFlip, ArginfoArrayFlip, uint32(g.SizeOf("arginfo_array_flip")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_change_key_case", ZifArrayChangeKeyCase, ArginfoArrayChangeKeyCase, uint32(g.SizeOf("arginfo_array_change_key_case")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_rand", ZifArrayRand, ArginfoArrayRand, uint32(g.SizeOf("arginfo_array_rand")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_unique", ZifArrayUnique, ArginfoArrayUnique, uint32(g.SizeOf("arginfo_array_unique")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_intersect", ZifArrayIntersect, ArginfoArrayIntersect, uint32(g.SizeOf("arginfo_array_intersect")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_intersect_key", ZifArrayIntersectKey, ArginfoArrayIntersectKey, uint32(g.SizeOf("arginfo_array_intersect_key")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_intersect_ukey", ZifArrayIntersectUkey, ArginfoArrayIntersectUkey, uint32(g.SizeOf("arginfo_array_intersect_ukey")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_uintersect", ZifArrayUintersect, ArginfoArrayUintersect, uint32(g.SizeOf("arginfo_array_uintersect")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_intersect_assoc", ZifArrayIntersectAssoc, ArginfoArrayIntersectAssoc, uint32(g.SizeOf("arginfo_array_intersect_assoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_uintersect_assoc", ZifArrayUintersectAssoc, ArginfoArrayUintersectAssoc, uint32(g.SizeOf("arginfo_array_uintersect_assoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_intersect_uassoc", ZifArrayIntersectUassoc, ArginfoArrayIntersectUassoc, uint32(g.SizeOf("arginfo_array_intersect_uassoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_uintersect_uassoc", ZifArrayUintersectUassoc, ArginfoArrayUintersectUassoc, uint32(g.SizeOf("arginfo_array_uintersect_uassoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_diff", ZifArrayDiff, ArginfoArrayDiff, uint32(g.SizeOf("arginfo_array_diff")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_diff_key", ZifArrayDiffKey, ArginfoArrayDiffKey, uint32(g.SizeOf("arginfo_array_diff_key")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_diff_ukey", ZifArrayDiffUkey, ArginfoArrayDiffUkey, uint32(g.SizeOf("arginfo_array_diff_ukey")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_udiff", ZifArrayUdiff, ArginfoArrayUdiff, uint32(g.SizeOf("arginfo_array_udiff")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_diff_assoc", ZifArrayDiffAssoc, ArginfoArrayDiffAssoc, uint32(g.SizeOf("arginfo_array_diff_assoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_udiff_assoc", ZifArrayUdiffAssoc, ArginfoArrayUdiffAssoc, uint32(g.SizeOf("arginfo_array_udiff_assoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_diff_uassoc", ZifArrayDiffUassoc, ArginfoArrayDiffUassoc, uint32(g.SizeOf("arginfo_array_diff_uassoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_udiff_uassoc", ZifArrayUdiffUassoc, ArginfoArrayUdiffUassoc, uint32(g.SizeOf("arginfo_array_udiff_uassoc")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_sum", ZifArraySum, ArginfoArraySum, uint32(g.SizeOf("arginfo_array_sum")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_product", ZifArrayProduct, ArginfoArrayProduct, uint32(g.SizeOf("arginfo_array_product")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_filter", ZifArrayFilter, ArginfoArrayFilter, uint32(g.SizeOf("arginfo_array_filter")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_map", ZifArrayMap, ArginfoArrayMap, uint32(g.SizeOf("arginfo_array_map")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_chunk", ZifArrayChunk, ArginfoArrayChunk, uint32(g.SizeOf("arginfo_array_chunk")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_combine", ZifArrayCombine, ArginfoArrayCombine, uint32(g.SizeOf("arginfo_array_combine")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"array_key_exists", ZifArrayKeyExists, ArginfoArrayKeyExists, uint32(g.SizeOf("arginfo_array_key_exists")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"pos", ZifCurrent, ArginfoCurrent, uint32(g.SizeOf("arginfo_current")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sizeof", ZifCount, ArginfoCount, uint32(g.SizeOf("arginfo_count")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"key_exists", ZifArrayKeyExists, ArginfoArrayKeyExists, uint32(g.SizeOf("arginfo_array_key_exists")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"assert", ZifAssert, ArginfoAssert, uint32(g.SizeOf("arginfo_assert")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"assert_options", ZifAssertOptions, ArginfoAssertOptions, uint32(g.SizeOf("arginfo_assert_options")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"version_compare", ZifVersionCompare, ArginfoVersionCompare, uint32(g.SizeOf("arginfo_version_compare")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"ftok", ZifFtok, ArginfoFtok, uint32(g.SizeOf("arginfo_ftok")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"str_rot13", ZifStrRot13, ArginfoStrRot13, uint32(g.SizeOf("arginfo_str_rot13")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_get_filters", ZifStreamGetFilters, ArginfoStreamGetFilters, uint32(g.SizeOf("arginfo_stream_get_filters")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_filter_register", ZifStreamFilterRegister, ArginfoStreamFilterRegister, uint32(g.SizeOf("arginfo_stream_filter_register")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_bucket_make_writeable", ZifStreamBucketMakeWriteable, ArginfoStreamBucketMakeWriteable, uint32(g.SizeOf("arginfo_stream_bucket_make_writeable")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_bucket_prepend", ZifStreamBucketPrepend, ArginfoStreamBucketPrepend, uint32(g.SizeOf("arginfo_stream_bucket_prepend")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_bucket_append", ZifStreamBucketAppend, ArginfoStreamBucketAppend, uint32(g.SizeOf("arginfo_stream_bucket_append")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"stream_bucket_new", ZifStreamBucketNew, ArginfoStreamBucketNew, uint32(g.SizeOf("arginfo_stream_bucket_new")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"output_add_rewrite_var", core.ZifOutputAddRewriteVar, ArginfoOutputAddRewriteVar, uint32(g.SizeOf("arginfo_output_add_rewrite_var")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"output_reset_rewrite_vars", core.ZifOutputResetRewriteVars, ArginfoOutputResetRewriteVars, uint32(g.SizeOf("arginfo_output_reset_rewrite_vars")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {"sys_get_temp_dir", ZifSysGetTempDir, ArginfoSysGetTempDir, uint32(g.SizeOf("arginfo_sys_get_temp_dir")/g.SizeOf("struct _zend_internal_arg_info") - 1), 0}, {nil, nil, nil, 0, 0}}
