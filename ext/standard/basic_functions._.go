...
var BasicFunctions []types.FunctionEntry = []types.FunctionEntry{
	...
	types.MakeZendFunctionEntryEx("dns_get_record", 0, ZifDnsGetRecord, []zend.ArgInfo{zend.MakeReturnArgInfo(1),
		...
		zend.MakeArgInfo("authns", zend.ArgInfoType(types.TypeHintCode(types.IS_ARRAY, 1)), zend.ArgInfoByRef(1)),
		zend.MakeArgInfo("addtl", zend.ArgInfoType(types.TypeHintCode(types.IS_ARRAY, 1)), zend.ArgInfoByRef(1)),
