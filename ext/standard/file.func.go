...
func ZmStartupFile(moduleNumber int) int {
	LeStreamContext = zend.ZendRegisterListDestructorsEx(FileContextDtor, nil, "stream-context", moduleNumber)
	FileGlobals = NewPhpFileGlobals(core.PHP_SOCK_CHUNK_SIZE)
	zend.REGISTER_INI_ENTRIES(moduleNumber)
	zend.RegisterLongConstant("SEEK_SET", r.SEEK_SET, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SEEK_CUR", r.SEEK_CUR, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SEEK_END", r.SEEK_END, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("LOCK_SH", PHP_LOCK_SH, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("LOCK_EX", PHP_LOCK_EX, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("LOCK_UN", PHP_LOCK_UN, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("LOCK_NB", PHP_LOCK_NB, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_CONNECT", streams.PHP_STREAM_NOTIFY_CONNECT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_AUTH_REQUIRED", streams.PHP_STREAM_NOTIFY_AUTH_REQUIRED, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_AUTH_RESULT", streams.PHP_STREAM_NOTIFY_AUTH_RESULT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_MIME_TYPE_IS", streams.PHP_STREAM_NOTIFY_MIME_TYPE_IS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_FILE_SIZE_IS", streams.PHP_STREAM_NOTIFY_FILE_SIZE_IS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_REDIRECTED", streams.PHP_STREAM_NOTIFY_REDIRECTED, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_PROGRESS", streams.PHP_STREAM_NOTIFY_PROGRESS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_FAILURE", streams.PHP_STREAM_NOTIFY_FAILURE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_COMPLETED", streams.PHP_STREAM_NOTIFY_COMPLETED, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_RESOLVE", streams.PHP_STREAM_NOTIFY_RESOLVE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_SEVERITY_INFO", streams.PHP_STREAM_NOTIFY_SEVERITY_INFO, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_SEVERITY_WARN", streams.PHP_STREAM_NOTIFY_SEVERITY_WARN, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_NOTIFY_SEVERITY_ERR", streams.PHP_STREAM_NOTIFY_SEVERITY_ERR, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_FILTER_READ", streams.PHP_STREAM_FILTER_READ, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_FILTER_WRITE", streams.PHP_STREAM_FILTER_WRITE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_FILTER_ALL", streams.PHP_STREAM_FILTER_ALL, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CLIENT_PERSISTENT", PHP_STREAM_CLIENT_PERSISTENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CLIENT_ASYNC_CONNECT", PHP_STREAM_CLIENT_ASYNC_CONNECT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CLIENT_CONNECT", PHP_STREAM_CLIENT_CONNECT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_ANY_CLIENT", streams.STREAM_CRYPTO_METHOD_ANY_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv2_CLIENT", streams.STREAM_CRYPTO_METHOD_SSLv2_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv3_CLIENT", streams.STREAM_CRYPTO_METHOD_SSLv3_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv23_CLIENT", streams.STREAM_CRYPTO_METHOD_SSLv23_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLS_CLIENT", streams.STREAM_CRYPTO_METHOD_TLS_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_0_CLIENT", streams.STREAM_CRYPTO_METHOD_TLSv1_0_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_1_CLIENT", streams.STREAM_CRYPTO_METHOD_TLSv1_1_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT", streams.STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_3_CLIENT", streams.STREAM_CRYPTO_METHOD_TLSv1_3_CLIENT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_ANY_SERVER", streams.STREAM_CRYPTO_METHOD_ANY_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv2_SERVER", streams.STREAM_CRYPTO_METHOD_SSLv2_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv3_SERVER", streams.STREAM_CRYPTO_METHOD_SSLv3_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_SSLv23_SERVER", streams.STREAM_CRYPTO_METHOD_SSLv23_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLS_SERVER", streams.STREAM_CRYPTO_METHOD_TLS_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_0_SERVER", streams.STREAM_CRYPTO_METHOD_TLSv1_0_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_1_SERVER", streams.STREAM_CRYPTO_METHOD_TLSv1_1_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_2_SERVER", streams.STREAM_CRYPTO_METHOD_TLSv1_2_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_METHOD_TLSv1_3_SERVER", streams.STREAM_CRYPTO_METHOD_TLSv1_3_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_PROTO_SSLv3", streams.STREAM_CRYPTO_METHOD_SSLv3_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_PROTO_TLSv1_0", streams.STREAM_CRYPTO_METHOD_TLSv1_0_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_PROTO_TLSv1_1", streams.STREAM_CRYPTO_METHOD_TLSv1_1_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_PROTO_TLSv1_2", streams.STREAM_CRYPTO_METHOD_TLSv1_2_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_CRYPTO_PROTO_TLSv1_3", streams.STREAM_CRYPTO_METHOD_TLSv1_3_SERVER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SHUT_RD", streams.STREAM_SHUT_RD, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SHUT_WR", streams.STREAM_SHUT_WR, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SHUT_RDWR", streams.STREAM_SHUT_RDWR, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SOCK_STREAM", SOCK_STREAM, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SOCK_DGRAM", SOCK_DGRAM, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_PEEK", streams.STREAM_PEEK, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_OOB", streams.STREAM_OOB, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SERVER_BIND", streams.STREAM_XPORT_BIND, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("STREAM_SERVER_LISTEN", streams.STREAM_XPORT_LISTEN, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_USE_INCLUDE_PATH", PHP_FILE_USE_INCLUDE_PATH, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_IGNORE_NEW_LINES", PHP_FILE_IGNORE_NEW_LINES, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_SKIP_EMPTY_LINES", PHP_FILE_SKIP_EMPTY_LINES, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_APPEND", PHP_FILE_APPEND, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_NO_DEFAULT_CONTEXT", PHP_FILE_NO_DEFAULT_CONTEXT, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_TEXT", 0, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FILE_BINARY", 0, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FNM_NOESCAPE", FNM_NOESCAPE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FNM_PATHNAME", FNM_PATHNAME, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("FNM_PERIOD", FNM_PERIOD, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
...
func ZifFlock(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, operation *types.Zval, _ zpp.Opt, wouldblock zpp.RefZval) {
	...
	act = operation & 3
	if act < 1 || act > 3 {
		core.PhpErrorDocref("", faults.E_WARNING, "Illegal operation argument")
...
func ZifFileGetContents(executeData zpp.Ex, return_value zpp.Ret, filename *types.Zval, _ zpp.Opt, flags *types.Zval, context *types.Zval, offset *types.Zval, maxlen *types.Zval) {
	...
	if executeData.NumArgs() == 5 && maxlen < 0 {
		core.PhpErrorDocref("", faults.E_WARNING, "length must be greater than or equal to zero")
		return_value.SetFalse()
		return
	}
...
func ZifFilePutContents(executeData zpp.Ex, return_value zpp.Ret, filename *types.Zval, data *types.Zval, _ zpp.Opt, flags *types.Zval, context *types.Zval) {
	var stream *core.PhpStream
	var filename *byte
	var filename_len int
	var data *types.Zval
	...
	if (flags&LOCK_EX) != 0 && (core.PhpStreamSupportsLock(stream) == 0 || core.PhpStreamLock(stream, LOCK_EX) != 0) {
		core.PhpStreamClose(stream)
		core.PhpErrorDocref("", faults.E_WARNING, "Exclusive locks are not supported for this stream")
		return_value.SetFalse()
		return
	}
	if mode[0] == 'c' {
...
func ZifFile(executeData zpp.Ex, return_value zpp.Ret, filename *types.Zval, _ zpp.Opt, flags *types.Zval, context *types.Zval) {
	var filename *byte
	var filename_len int
	var p *byte
	var s *byte
...
func ZifTempnam(executeData zpp.Ex, return_value zpp.Ret, dir *types.Zval, prefix *types.Zval) {
	var dir *byte
	var prefix *byte
	var dir_len int
	var prefix_len int
...
func ZifOpen(executeData zpp.Ex, return_value zpp.Ret, filename *types.Zval, mode *types.Zval, _ zpp.Opt, use_include_path *types.Zval, context *types.Zval) {
	var filename *byte
	var mode *byte
	var filename_len int
	var mode_len int
...
func ZifFclose(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
	var stream *core.PhpStream
	for {
		for {
...
func ZifPopen(executeData zpp.Ex, return_value zpp.Ret, command *types.Zval, mode *types.Zval) {
	var command *byte
	var mode *byte
	var command_len int
	var mode_len int
...
func ZifPclose(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
	var stream *core.PhpStream
	for {
		for {
...
//@zif -alias fputs
func ZifFwrite(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, str *types.Zval, _ zpp.Opt, length *types.Zval) {
	var res *types.Zval
	var input *byte
	var inputlen int
	var ret ssize_t
...
func ZifFflush(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
	var ret int
	var stream *core.PhpStream
	for {
...
func ZifRewind(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
	var stream *core.PhpStream
	for {
		for {
...
func ZifFtell(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
...
func ZifFseek(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, offset *types.Zval, _ zpp.Opt, whence *types.Zval) {
	var res *types.Zval
...
func ZifMkdir(executeData zpp.Ex, return_value zpp.Ret, pathname *types.Zval, _ zpp.Opt, mode *types.Zval, recursive *types.Zval, context *types.Zval) {
	var dir *byte
	var dir_len int
	var zcontext *types.Zval = nil
...
func ZifUmask(executeData zpp.Ex, return_value zpp.Ret, _ zpp.Opt, mask *types.Zval) {
...
func ZifFpassthru(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval) {
	var res *types.Zval
	var size int
	var stream *core.PhpStream
	for {
...
func ZifRename(executeData zpp.Ex, return_value zpp.Ret, oldName *types.Zval, newName *types.Zval, _ zpp.Opt, context *types.Zval) {
	var old_name *byte
	var new_name *byte
	...
	if wrapper == nil || wrapper.GetWops() == nil {
		core.PhpErrorDocref("", faults.E_WARNING, "Unable to locate stream wrapper")
		return_value.SetFalse()
		return
	}
	...
	if wrapper != streams.PhpStreamLocateUrlWrapper(new_name, nil, 0) {
		core.PhpErrorDocref("", faults.E_WARNING, "Cannot rename a file across wrapper types")
		return_value.SetFalse()
		return
	}
	context = streams.PhpStreamContextFromZval(zcontext, 0)
...
func ZifFtruncate(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, size *types.Zval) {
	...
	if size < 0 {
		core.PhpErrorDocref("", faults.E_WARNING, "Negative size is not supported")
		return_value.SetFalse()
		return
	}
	PHP_STREAM_TO_ZVAL(stream, fp)
	if core.PhpStreamTruncateSupported(stream) == 0 {
		core.PhpErrorDocref("", faults.E_WARNING, "Can't truncate this stream!")
		return_value.SetFalse()
		return
	}
...
func PhpCopyFileCtx(src *byte, dest *byte, src_flg int, ctx *core.PhpStreamContext) int {
	...
	if zend.S_ISDIR(src_s.GetSb().st_mode) {
		core.PhpErrorDocref("", faults.E_WARNING, "The first argument to copy() function cannot be a directory")
	...
	if zend.S_ISDIR(dest_s.GetSb().st_mode) {
		core.PhpErrorDocref("", faults.E_WARNING, "The second argument to copy() function cannot be a directory")
		return types.FAILURE
	}
...
func ZifFread(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, length *types.Zval) {
	var res *types.Zval
...
func ZifFputcsv(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, fields *types.Zval, _ zpp.Opt, delimiter *types.Zval, enclosure *types.Zval, escapeChar *types.Zval) {
	var delimiter byte = ','
	var enclosure byte = '"'
	...
	if delimiter_str != nil {
		...
		if delimiter_str_len < 1 {
			...
			core.PhpErrorDocref("", faults.E_NOTICE, "delimiter must be a single character")
		}
	...
	if enclosure_str != nil {
		if enclosure_str_len < 1 {
			...
			core.PhpErrorDocref("", faults.E_NOTICE, "enclosure must be a single character")
		}
	...
	if escape_str != nil {
		if escape_str_len > 1 {
			core.PhpErrorDocref("", faults.E_NOTICE, "escape must be empty or a single character")
		}
		if escape_str_len < 1 {
...
func ZifFgetcsv(executeData zpp.Ex, return_value zpp.Ret, fp *types.Zval, _ zpp.Opt, length *types.Zval, delimiter *types.Zval, enclosure *types.Zval, escape *types.Zval) {
	var delimiter byte = ','
	var enclosure byte = '"'
	...
	if len_zv != nil && !len_zv.IsNull() {
		...
		if len_ < 0 {
			core.PhpErrorDocref("", faults.E_WARNING, "Length parameter may not be negative")
			return_value.SetFalse()
			return
		} else if len_ == 0 {
			len_ = -1
...
func ZifRealpath(executeData zpp.Ex, return_value zpp.Ret, path *types.Zval) {
	var filename *byte
	var filename_len int
...
func ZifFnmatch(executeData zpp.Ex, return_value zpp.Ret, pattern *types.Zval, filename *types.Zval, _ zpp.Opt, flags *types.Zval) {
	var pattern *byte
	var filename *byte
	var pattern_len int
	var filename_len int
