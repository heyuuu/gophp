...
func (this *PhpPasswordAlgo) SetHash(value func(password *zend.ZendString, options *zend.ZendArray) *zend.ZendString) {
	this.hash = value
}
func (this PhpPasswordAlgo) GetVerify() func(password *zend.ZendString, hash *zend.ZendString) zend.ZendBool {
	return this.verify
}
func (this *PhpPasswordAlgo) SetVerify(value func(password *zend.ZendString, hash *zend.ZendString) zend.ZendBool) {
	this.verify = value
}
...
func (this *PhpPasswordAlgo) SetNeedsRehash(value func(password *zend.ZendString, options *zend.ZendArray) zend.ZendBool) {
	this.needs_rehash = value
}
func (this PhpPasswordAlgo) GetGetInfo() func(return_value *zend.Zval, hash *zend.ZendString) int {
	return this.get_info
}
func (this *PhpPasswordAlgo) SetGetInfo(value func(return_value *zend.Zval, hash *zend.ZendString) int) {
	this.get_info = value
}
func (this PhpPasswordAlgo) GetValid() func(hash *zend.ZendString) zend.ZendBool { return this.valid }
func (this *PhpPasswordAlgo) SetValid(value func(hash *zend.ZendString) zend.ZendBool) {
	this.valid = value
}
