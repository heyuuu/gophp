...
func ZifAssertOptions(executeData zpp.Ex, return_value zpp.Ret, what *types.Zval, _ zpp.Opt, value *types.Zval) {
	...
	case ASSERT_ACTIVE:
		...
		if ac == 2 {
			...
			zend.ZendAlterIniEntryEx(key.GetStr(), value_str.GetStr(), core.PHP_INI_USER, core.PHP_INI_STAGE_RUNTIME, 0)
	...
	case ASSERT_EXCEPTION:
		...
		if ac == 2 {
			...
			zend.ZendAlterIniEntryEx(key.GetStr(), val.GetStr(), core.PHP_INI_USER, core.PHP_INI_STAGE_RUNTIME, 0)
