...
// func (this *PhpBasicGlobals)  GetUserShutdownFunctionNames() *zend.HashTable      { return this.user_shutdown_function_names }
// func (this *PhpBasicGlobals) SetUserShutdownFunctionNames(value *zend.HashTable) { this.user_shutdown_function_names = value }
...
// func (this *PhpBasicGlobals)  GetArrayWalkFciCache() zend.ZendFcallInfoCache      { return this.array_walk_fci_cache }
// func (this *PhpBasicGlobals) SetArrayWalkFciCache(value zend.ZendFcallInfoCache) { this.array_walk_fci_cache = value }
// func (this *PhpBasicGlobals)  GetUserCompareFci() zend.ZendFcallInfo      { return this.user_compare_fci }
// func (this *PhpBasicGlobals) SetUserCompareFci(value zend.ZendFcallInfo) { this.user_compare_fci = value }
// func (this *PhpBasicGlobals)  GetUserCompareFciCache() zend.ZendFcallInfoCache      { return this.user_compare_fci_cache }
// func (this *PhpBasicGlobals) SetUserCompareFciCache(value zend.ZendFcallInfoCache) { this.user_compare_fci_cache = value }
// func (this *PhpBasicGlobals)  GetUserTickFunctions() *zend.ZendLlist      { return this.user_tick_functions }
// func (this *PhpBasicGlobals) SetUserTickFunctions(value *zend.ZendLlist) { this.user_tick_functions = value }
// func (this *PhpBasicGlobals)  GetActiveIniFileSection() zend.Zval      { return this.active_ini_file_section }
// func (this *PhpBasicGlobals) SetActiveIniFileSection(value zend.Zval) { this.active_ini_file_section = value }
...
// func (this *PhpBasicGlobals) SetUnserializeData(value *PhpUnserializeData) { this.unserialize.data = value }
...
// func (this *PhpBasicGlobals) SetUrlAdaptSessionHostsHt(value zend.HashTable) { this.url_adapt_session_hosts_ht = value }
...
// func (this *PhpBasicGlobals) SetUrlAdaptOutputHostsHt(value zend.HashTable) { this.url_adapt_output_hosts_ht = value }
...
// func (this *PhpBasicGlobals)  GetUnserializeMaxDepth() zend.ZendLong      { return this.unserialize_max_depth }
// func (this *PhpBasicGlobals) SetUnserializeMaxDepth(value zend.ZendLong) { this.unserialize_max_depth = value }
