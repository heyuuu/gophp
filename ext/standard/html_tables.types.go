...
func (this *EntityMulticodepointRow) SetDefaultEntity(value *byte) {
	this.leading_entry.default_entity = value
}
...
func (this *EntityMulticodepointRow) SetDefaultEntityLen(value uint16) {
	this.leading_entry.default_entity_len = value
}
...
func (this *EntityStage3Row) SetMulticodepointTable(value *EntityMulticodepointRow) {
	this.data.multicodepoint_table = value
}
