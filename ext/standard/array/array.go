 ...
 * functions
 */
func ZmStartupArray(moduleNumber int) int {
	zend.RegisterLongConstant("EXTR_OVERWRITE", EXTR_OVERWRITE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_SKIP", EXTR_SKIP, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_PREFIX_SAME", EXTR_PREFIX_SAME, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_PREFIX_ALL", EXTR_PREFIX_ALL, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_PREFIX_INVALID", EXTR_PREFIX_INVALID, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_PREFIX_IF_EXISTS", EXTR_PREFIX_IF_EXISTS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_IF_EXISTS", EXTR_IF_EXISTS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("EXTR_REFS", EXTR_REFS, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_ASC", PHP_SORT_ASC, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_DESC", PHP_SORT_DESC, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_REGULAR", PHP_SORT_REGULAR, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_NUMERIC", PHP_SORT_NUMERIC, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_STRING", PHP_SORT_STRING, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_LOCALE_STRING", PHP_SORT_LOCALE_STRING, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_NATURAL", PHP_SORT_NATURAL, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("SORT_FLAG_CASE", PHP_SORT_FLAG_CASE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("CASE_LOWER", CASE_LOWER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("CASE_UPPER", CASE_UPPER, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("COUNT_NORMAL", COUNT_NORMAL, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("COUNT_RECURSIVE", COUNT_RECURSIVE, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("ARRAY_FILTER_USE_BOTH", ARRAY_FILTER_USE_BOTH, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
	zend.RegisterLongConstant("ARRAY_FILTER_USE_KEY", ARRAY_FILTER_USE_KEY, zend.CONST_CS|zend.CONST_PERSISTENT, moduleNumber)
...
func ArrayColumnFetchProp(data *types.Zval, name *types.Zval) *types.Zval {
	...
	if data.IsType(types.IsObject) {
		...
		if data.Object().HasPropertyEx(name, zend.ZEND_PROPERTY_EXISTS) || data.Object().HasPropertyEx(name, zend.ZEND_PROPERTY_ISSET) {
			prop = data.Object().ReadPropertyEx(name, zend.BP_VAR_R, &rv)
			if prop != nil {
