...
const (
	ZEND_AST_ZVAL ZendAstKind = 1<<ZEND_AST_SPECIAL_SHIFT + iota
	ZEND_AST_CONSTANT
	ZEND_AST_ZNODE
	ZEND_AST_FUNC_DECL
	ZEND_AST_CLOSURE
...
const (
	ZEND_AST_ARG_LIST ZendAstKind = 1<<ZEND_AST_IS_LIST_SHIFT + iota
	ZEND_AST_ARRAY
...
const (
	ZEND_AST_MAGIC_CONST ZendAstKind = 0<<ZEND_AST_NUM_CHILDREN_SHIFT + iota
	ZEND_AST_TYPE
	ZEND_AST_CONSTANT_CLASS
)
const (
	ZEND_AST_VAR ZendAstKind = 1<<ZEND_AST_NUM_CHILDREN_SHIFT + iota
	ZEND_AST_CONST
	ZEND_AST_UNPACK
	ZEND_AST_UNARY_PLUS
...
const (
	ZEND_AST_DIM ZendAstKind = 2<<ZEND_AST_NUM_CHILDREN_SHIFT + iota
	ZEND_AST_PROP
...
const (
	ZEND_AST_METHOD_CALL ZendAstKind = 3<<ZEND_AST_NUM_CHILDREN_SHIFT + iota
...
const (
	ZEND_AST_FOR ZendAstKind = 4<<ZEND_AST_NUM_CHILDREN_SHIFT + iota
	ZEND_AST_FOREACH
)
