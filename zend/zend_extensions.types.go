...
// func (this *ZendExtension) SetOpArrayHandler(value OpArrayHandlerFuncT) { this.op_array_handler = value }
func (this *ZendExtension) GetStatementHandler() StatementHandlerFuncT { return this.statement_handler }

// func (this *ZendExtension) SetStatementHandler(value StatementHandlerFuncT) { this.statement_handler = value }
func (this *ZendExtension) GetFcallBeginHandler() FcallBeginHandlerFuncT {
	return this.fcall_begin_handler
}

// func (this *ZendExtension) SetFcallBeginHandler(value FcallBeginHandlerFuncT) { this.fcall_begin_handler = value }
func (this *ZendExtension) GetFcallEndHandler() FcallEndHandlerFuncT { return this.fcall_end_handler }

// func (this *ZendExtension) SetFcallEndHandler(value FcallEndHandlerFuncT) { this.fcall_end_handler = value }
...
// func (this *ZendExtension) SetBuildIdCheck(value func(build_id *byte) int) { this.build_id_check = value }
func (this *ZendExtension) GetOpArrayPersistCalc() OpArrayPersistCalcFuncT {
	return this.op_array_persist_calc
}

// func (this *ZendExtension) SetOpArrayPersistCalc(value OpArrayPersistCalcFuncT) { this.op_array_persist_calc = value }
func (this *ZendExtension) GetOpArrayPersist() OpArrayPersistFuncT { return this.op_array_persist }

// func (this *ZendExtension) SetOpArrayPersist(value OpArrayPersistFuncT) { this.op_array_persist = value }
