...
func ZendRegisterInterfaces() {
	...
	ce.SetName(types.NewString("Traversable"))
	...
	var ce types.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types.NewString("IteratorAggregate"))
	...
	var ce types.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types.NewString("Iterator"))
	...
	var ce types.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types.NewString("ArrayAccess"))
	...
	var ce types.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types.NewString("Serializable"))
	...
	var ce types.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types.NewString("Countable"))
