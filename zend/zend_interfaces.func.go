...
func ZendCallMethodWith0Params(obj *types2.Zval, obj_ce *types2.ClassEntry, fn_proxy *types2.IFunction, function_name string, retval *types2.Zval) *types2.Zval {
	return ZendCallMethod(obj, obj_ce, fn_proxy, function_name, retval, 0, nil, nil)
}
func ZendCallMethodWith1Params(
	obj *types2.Zval,
	obj_ce *types2.ClassEntry,
	fn_proxy *types2.IFunction,
...
func ZendCallMethod(
	...
	if param_count > 0 {
		types2.ZVAL_COPY_VALUE(&params[0], arg1)
	}
	if param_count > 1 {
		types2.ZVAL_COPY_VALUE(&params[1], arg2)
	}
	...
	if fn_proxy == nil && obj_ce == nil {
		...
		if obj_ce == nil {
			if object != nil {
				obj_ce = types2.Z_OBJCE_P(object)
			} else {
				obj_ce = nil
			}
		}
		...
		if object != nil {
			fcic.SetCalledScope(types2.Z_OBJCE_P(object))
		} else {
...
func ZendUserItNewIterator(ce *types2.ClassEntry, object *types2.Zval, retval *types2.Zval) {
...
func ZendUserItDtor(_iter *ZendObjectIterator) {
	var iter *ZendUserIterator = (*ZendUserIterator)(_iter)
	var object *types2.Zval = iter.GetIt().GetData()
...
func ZendUserItGetCurrentData(_iter *ZendObjectIterator) *types2.Zval {
	var iter *ZendUserIterator = (*ZendUserIterator)(_iter)
	var object *types2.Zval = iter.GetIt().GetData()
	if iter.GetValue().IsUndef() {
...
func ZendUserItGetCurrentKey(_iter *ZendObjectIterator, key *types2.Zval) {
	var iter *ZendUserIterator = (*ZendUserIterator)(_iter)
	var object *types2.Zval = iter.GetIt().GetData()
	var retval types2.Zval
...
func ZendUserItGetIterator(ce *types2.ClassEntry, object *types2.Zval, by_ref int) *ZendObjectIterator {
	...
	iterator.SetCe(types2.Z_OBJCE_P(object))
	iterator.GetValue().SetUndef()
	return (*ZendObjectIterator)(iterator)
}
func ZendUserItGetNewIterator(ce *types2.ClassEntry, object *types2.Zval, by_ref int) *ZendObjectIterator {
	var iterator types2.Zval
	var new_iterator *ZendObjectIterator
	var ce_it *types2.ClassEntry
	ZendUserItNewIterator(ce, object, &iterator)
	if iterator.IsObject() {
		ce_it = types2.Z_OBJCE(iterator)
	} else {
		ce_it = nil
	}
	if ce_it == nil || ce_it.GetGetIterator() == nil || ce_it.GetGetIterator() == ZendUserItGetNewIterator && iterator.Object() == object.Object() {
		if EG__().GetException() == nil {
			faults.ThrowExceptionEx(nil, 0, "Objects returned by %s::getIterator() must be traversable or implement interface Iterator", b.CondF(ce != nil, func() []byte { return ce.GetName().GetVal() }, func() []byte { return types2.Z_OBJCE_P(object).GetName().GetVal() }))
		}
...
func ZendImplementTraversable(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
...
func ZendImplementAggregate(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
	var i uint32
	var t int = -1
...
func ZendImplementIterator(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
	var funcs_ptr *ZendClassIteratorFuncs
...
func ZendImplementArrayaccess(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
	return types2.SUCCESS
}
func ZendUserSerialize(object *types2.Zval, buffer **uint8, buf_len *int, data *ZendSerializeData) int {
	...
	if result == types2.FAILURE && EG__().GetException() == nil {
		faults.ThrowExceptionEx(nil, 0, "%s::serialize() must return a string or NULL", ce.GetName().GetVal())
	}
	return result
}
func ZendUserUnserialize(object *types2.Zval, ce *types2.ClassEntry, buf *uint8, buf_len int, data *ZendUnserializeData) int {
	var zdata types2.Zval
	if ObjectInitEx(object, ce) != types2.SUCCESS {
		return types2.FAILURE
	}
...
func ZendClassSerializeDeny(object *types2.Zval, buffer **uint8, buf_len *int, data *ZendSerializeData) int {
	var ce *types2.ClassEntry = types2.Z_OBJCE_P(object)
	faults.ThrowExceptionEx(nil, 0, "Serialization of '%s' is not allowed", ce.GetName().GetVal())
	return types2.FAILURE
}
func ZendClassUnserializeDeny(object *types2.Zval, ce *types2.ClassEntry, buf *uint8, buf_len int, data *ZendUnserializeData) int {
	faults.ThrowExceptionEx(nil, 0, "Unserialization of '%s' is not allowed", ce.GetName().GetVal())
	return types2.FAILURE
}
func ZendImplementSerializable(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
...
func ZendImplementCountable(interface_ *types2.ClassEntry, class_type *types2.ClassEntry) int {
	return types2.SUCCESS
}
func ZendRegisterInterfaces() {
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("Traversable"))
	...
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("IteratorAggregate"))
	...
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("Iterator"))
	...
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("ArrayAccess"))
	...
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("Serializable"))
	...
	var ce types2.ClassEntry
	memset(&ce, 0, b.SizeOf("zend_class_entry"))
	ce.SetName(types2.NewString("Countable"))
