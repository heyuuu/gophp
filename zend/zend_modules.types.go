...
// func (this *ZendModuleEntry) SetModuleStartupFunc(value func(type_ int, module_number int) int) { this.module_startup_func = value }
func (this *ZendModuleEntry) GetModuleShutdownFunc() func(type_ int, module_number int) int {
	return this.module_shutdown_func
}

// func (this *ZendModuleEntry) SetModuleShutdownFunc(value func(type_ int, module_number int) int) { this.module_shutdown_func = value }
func (this *ZendModuleEntry) GetRequestStartupFunc() func(type_ int, module_number int) int {
	return this.request_startup_func
}

// func (this *ZendModuleEntry) SetRequestStartupFunc(value func(type_ int, module_number int) int) { this.request_startup_func = value }
func (this *ZendModuleEntry) GetRequestShutdownFunc() func(type_ int, module_number int) int {
	return this.request_shutdown_func
}

// func (this *ZendModuleEntry) SetRequestShutdownFunc(value func(type_ int, module_number int) int) { this.request_shutdown_func = value }
...
// func (this *ZendModuleEntry) SetPostDeactivateFunc(value func() int) { this.post_deactivate_func = value }
...
// func NewZendModuleDep(name *byte, rel *byte, version *byte, type_ uint8) *ZendModuleDep {
