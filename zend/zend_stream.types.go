...
func (this *ZendFileHandle) GetOpenedPath() *types.String      { return this.openedPath }
func (this *ZendFileHandle) SetOpenedPath(value *types.String) { this.openedPath = value }
