...
func ZendInitDynamicCallObject(function *types.Zval, num_args uint32) *ZendExecuteData {
	...
	if function.Object().Handlers().GetGetClosure() != nil && function.Object().Handlers().GetGetClosure()(function, &called_scope, &fbc, &object) == types.SUCCESS {
...
func ZendInitDynamicCallArray(function *types.Array, num_args uint32) *ZendExecuteData {
	...
	if function.Len() == 2 {
		...
		if obj.IsString() {
			...
			fbc = obj.Object().Handlers().GetGetMethod()(&object, method.String(), nil)
			if fbc == nil {
				if EG__().GetException() == nil {
