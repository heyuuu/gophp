...
func NewInternalFunctionEx(funcName string, handler zend.ZifHandler) *ZendInternalFunction {
	return &ZendInternalFunction{
		function_name: NewString(funcName),
		handler:       handler,
	}
}
...
func (this *ZendInternalFunction) InitByEntry(entry *ZendFunctionEntry) {
	...
	this.function_name = NewString(entry.FuncName())
	this.prototype = nil
}

func (this *ZendInternalFunction) GetType() uint8 { return zend.ZEND_INTERNAL_FUNCTION }
...
func (this *ZendInternalFunction) GetFunctionName() *String { return this.function_name }
...
func (this *ZendInternalFunction) SetScope(value *ClassEntry) { this.scope = value }
...
func (this *ZendInternalFunction) GetArgInfo() *zend.ArgInfo         { return this.arg_info }
func (this *ZendInternalFunction) SetArgInfo(value *zend.ArgInfo)    { this.arg_info = value }
...
func (this ZendInternalFunction) IsVariadic() bool { return this.HasFnFlags(zend.ZEND_ACC_VARIADIC) }
...
func (this ZendInternalFunction) IsUserArgInfo() bool {
	return this.HasFnFlags(zend.ZEND_ACC_USER_ARG_INFO)
}
func (this *ZendInternalFunction) SetIsVariadic(cond bool) {
	this.SwitchFnFlags(zend.ZEND_ACC_VARIADIC, cond)
}
