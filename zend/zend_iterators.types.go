...
func (this *ZendObjectIteratorFuncs) SetValid(value func(iter *ZendObjectIterator) int) {
	this.valid = value
}
func (this *ZendObjectIteratorFuncs) GetGetCurrentData() func(iter *ZendObjectIterator) *Zval {
	return this.get_current_data
}
func (this *ZendObjectIteratorFuncs) SetGetCurrentData(value func(iter *ZendObjectIterator) *Zval) {
	this.get_current_data = value
}
func (this *ZendObjectIteratorFuncs) GetGetCurrentKey() func(iter *ZendObjectIterator, key *Zval) {
	return this.get_current_key
}
func (this *ZendObjectIteratorFuncs) SetGetCurrentKey(value func(iter *ZendObjectIterator, key *Zval)) {
	this.get_current_key = value
}
func (this *ZendObjectIteratorFuncs) GetMoveForward() func(iter *ZendObjectIterator) {
	return this.move_forward
}
func (this *ZendObjectIteratorFuncs) SetMoveForward(value func(iter *ZendObjectIterator)) {
	this.move_forward = value
}
func (this *ZendObjectIteratorFuncs) GetRewind() func(iter *ZendObjectIterator) { return this.rewind }
func (this *ZendObjectIteratorFuncs) SetRewind(value func(iter *ZendObjectIterator)) {
	this.rewind = value
}
func (this *ZendObjectIteratorFuncs) GetInvalidateCurrent() func(iter *ZendObjectIterator) {
	return this.invalidate_current
}
func (this *ZendObjectIteratorFuncs) SetInvalidateCurrent(value func(iter *ZendObjectIterator)) {
	this.invalidate_current = value
}
