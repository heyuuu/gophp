...
// func NewZendObjectHandlers(offset int, free_obj ZendObjectFreeObjT, dtor_obj ZendObjectDtorObjT, clone_obj ZendObjectCloneObjT, read_property ZendObjectReadPropertyT, write_property ZendObjectWritePropertyT, read_dimension ZendObjectReadDimensionT, write_dimension ZendObjectWriteDimensionT, get_property_ptr_ptr ZendObjectGetPropertyPtrPtrT, get ZendObjectGetT, set ZendObjectSetT, has_property ZendObjectHasPropertyT, unset_property ZendObjectUnsetPropertyT, has_dimension ZendObjectHasDimensionT, unset_dimension ZendObjectUnsetDimensionT, get_properties ZendObjectGetPropertiesT, get_method ZendObjectGetMethodT, call_method ZendObjectCallMethodT, get_constructor ZendObjectGetConstructorT, get_class_name ZendObjectGetClassNameT, compare_objects ZendObjectCompareT, cast_object ZendObjectCastT, count_elements ZendObjectCountElementsT, get_debug_info ZendObjectGetDebugInfoT, get_closure ZendObjectGetClosureT, get_gc ZendObjectGetGcT, do_operation ZendObjectDoOperationT, compare ZendObjectCompareZvalsT, get_properties_for ZendObjectGetPropertiesForT) *ZendObjectHandlers {
...
//     }
// }
// func MakeZendObjectHandlers(offset int, free_obj ZendObjectFreeObjT, dtor_obj ZendObjectDtorObjT, clone_obj ZendObjectCloneObjT, read_property ZendObjectReadPropertyT, write_property ZendObjectWritePropertyT, read_dimension ZendObjectReadDimensionT, write_dimension ZendObjectWriteDimensionT, get_property_ptr_ptr ZendObjectGetPropertyPtrPtrT, get ZendObjectGetT, set ZendObjectSetT, has_property ZendObjectHasPropertyT, unset_property ZendObjectUnsetPropertyT, has_dimension ZendObjectHasDimensionT, unset_dimension ZendObjectUnsetDimensionT, get_properties ZendObjectGetPropertiesT, get_method ZendObjectGetMethodT, call_method ZendObjectCallMethodT, get_constructor ZendObjectGetConstructorT, get_class_name ZendObjectGetClassNameT, compare_objects ZendObjectCompareT, cast_object ZendObjectCastT, count_elements ZendObjectCountElementsT, get_debug_info ZendObjectGetDebugInfoT, get_closure ZendObjectGetClosureT, get_gc ZendObjectGetGcT, do_operation ZendObjectDoOperationT, compare ZendObjectCompareZvalsT, get_properties_for ZendObjectGetPropertiesForT) ZendObjectHandlers {
//     return ZendObjectHandlers{
//         offset:offset,
//         free_obj:free_obj,
//         dtor_obj:dtor_obj,
