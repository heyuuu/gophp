...
func (this *ZendObjectHandlers) SetGetClassName(value ZendObjectGetClassNameT) {
	this.get_class_name = value
}
...
func (this *ZendObjectHandlers) SetDoOperation(value ZendObjectDoOperationT) {
	this.do_operation = value
}
