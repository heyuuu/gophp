...
func (this ZendCompilerGlobals) GetActiveClassEntry() *ZendClassEntry { return this.active_class_entry }
...
func (this ZendCompilerGlobals) GetIniParserParam() *ZendIniParserParam { return this.ini_parser_param }
...
func (this ZendCompilerGlobals) GetDelayedOplinesStack() ZendStack   { return this.delayed_oplines_stack }
...
func (this ZendExecutorGlobals) GetSymtableCacheLimit() **ZendArray   { return this.symtable_cache_limit }
...
func (this ZendPhpScannerGlobals) GetYyIn() *ZendFileHandle        { return this.yy_in }
func (this *ZendPhpScannerGlobals) SetYyIn(value *ZendFileHandle)  { this.yy_in = value }
func (this ZendPhpScannerGlobals) GetYyOut() *ZendFileHandle       { return this.yy_out }
func (this *ZendPhpScannerGlobals) SetYyOut(value *ZendFileHandle) { this.yy_out = value }
func (this ZendPhpScannerGlobals) GetYyLeng() uint                 { return this.yy_leng }
func (this *ZendPhpScannerGlobals) SetYyLeng(value uint)           { this.yy_leng = value }
func (this ZendPhpScannerGlobals) GetYyStart() *uint8              { return this.yy_start }
func (this *ZendPhpScannerGlobals) SetYyStart(value *uint8)        { this.yy_start = value }
func (this ZendPhpScannerGlobals) GetYyText() *uint8               { return this.yy_text }
func (this *ZendPhpScannerGlobals) SetYyText(value *uint8)         { this.yy_text = value }
func (this ZendPhpScannerGlobals) GetYyCursor() *uint8             { return this.yy_cursor }
func (this *ZendPhpScannerGlobals) SetYyCursor(value *uint8)       { this.yy_cursor = value }
func (this ZendPhpScannerGlobals) GetYyMarker() *uint8             { return this.yy_marker }
func (this *ZendPhpScannerGlobals) SetYyMarker(value *uint8)       { this.yy_marker = value }
func (this ZendPhpScannerGlobals) GetYyLimit() *uint8              { return this.yy_limit }
func (this *ZendPhpScannerGlobals) SetYyLimit(value *uint8)        { this.yy_limit = value }
func (this ZendPhpScannerGlobals) GetYyState() int                 { return this.yy_state }
...
func (this ZendPhpScannerGlobals) GetHeredocIndentation() int       { return this.heredoc_indentation }
func (this *ZendPhpScannerGlobals) SetHeredocIndentation(value int) { this.heredoc_indentation = value }
func (this ZendPhpScannerGlobals) GetHeredocIndentationUsesSpaces() ZendBool {
	return this.heredoc_indentation_uses_spaces
}
func (this *ZendPhpScannerGlobals) SetHeredocIndentationUsesSpaces(value ZendBool) {
	this.heredoc_indentation_uses_spaces = value
}
func (this ZendPhpScannerGlobals) GetScriptOrg() *uint8            { return this.script_org }
func (this *ZendPhpScannerGlobals) SetScriptOrg(value *uint8)      { this.script_org = value }
func (this ZendPhpScannerGlobals) GetScriptOrgSize() int           { return this.script_org_size }
func (this *ZendPhpScannerGlobals) SetScriptOrgSize(value int)     { this.script_org_size = value }
func (this ZendPhpScannerGlobals) GetScriptFiltered() *uint8       { return this.script_filtered }
func (this *ZendPhpScannerGlobals) SetScriptFiltered(value *uint8) { this.script_filtered = value }
func (this ZendPhpScannerGlobals) GetScriptFilteredSize() int      { return this.script_filtered_size }
func (this *ZendPhpScannerGlobals) SetScriptFilteredSize(value int) {
	this.script_filtered_size = value
}
func (this ZendPhpScannerGlobals) GetInputFilter() ZendEncodingFilter { return this.input_filter }
func (this *ZendPhpScannerGlobals) SetInputFilter(value ZendEncodingFilter) {
	this.input_filter = value
}
func (this ZendPhpScannerGlobals) GetOutputFilter() ZendEncodingFilter { return this.output_filter }
func (this *ZendPhpScannerGlobals) SetOutputFilter(value ZendEncodingFilter) {
	this.output_filter = value
}
func (this ZendPhpScannerGlobals) GetScriptEncoding() *ZendEncoding { return this.script_encoding }
func (this *ZendPhpScannerGlobals) SetScriptEncoding(value *ZendEncoding) {
	this.script_encoding = value
}
func (this ZendPhpScannerGlobals) GetScannedStringLen() int       { return this.scanned_string_len }
func (this *ZendPhpScannerGlobals) SetScannedStringLen(value int) { this.scanned_string_len = value }
func (this ZendPhpScannerGlobals) GetOnEvent() func(event ZendPhpScannerEvent, token int, line int, context any) {
	return this.on_event
}
func (this *ZendPhpScannerGlobals) SetOnEvent(value func(event ZendPhpScannerEvent, token int, line int, context any)) {
	this.on_event = value
}
func (this ZendPhpScannerGlobals) GetOnEventContext() any       { return this.on_event_context }
func (this *ZendPhpScannerGlobals) SetOnEventContext(value any) { this.on_event_context = value }
