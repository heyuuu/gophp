...
var ZendFuncsArrayaccess []ZendFunctionEntry = []ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_arrayaccess_offset")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
	},
	{
		"offsetGet",
		...
		uint32(b.SizeOf("arginfo_arrayaccess_offset_get")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
	},
	{
		"offsetSet",
		...
		uint32(b.SizeOf("arginfo_arrayaccess_offset_value")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
	},
	{
		"offsetUnset",
...
var ZendFuncsSerializable []ZendFunctionEntry = []ZendFunctionEntry{
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_serializable_serialize")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
	},
	{nil, nil, nil, 0, 0},
}
...
var ZendFuncsCountable []ZendFunctionEntry = []ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_countable_count")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC | ZEND_ACC_ABSTRACT,
	},
	{nil, nil, nil, 0, 0},
}
