...
func ZEND_GENERATOR_CREATE_SPEC_HANDLER(executeData *ZendExecuteData) int {
	...
	if return_value != nil {
		...
		generator.GetExecuteFake().SetScope((*types.Object)(generator))
		...
		if (call_info&types.Z_TYPE_MASK) == types.IsObject && ((call_info&(ZEND_CALL_CLOSURE|ZEND_CALL_RELEASE_THIS)) == 0 || ZendExecuteEx != ExecuteEx) {
