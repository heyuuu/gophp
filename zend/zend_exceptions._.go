...
var DefaultExceptionFunctions []ZendFunctionEntry = []ZendFunctionEntry{
	...
	},
	{
		...
		uint32(b.SizeOf("arginfo_exception___construct")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC,
	},
	{
		"__wakeup",
...
var ErrorExceptionFunctions []ZendFunctionEntry = []ZendFunctionEntry{
	{
		...
		uint32(b.SizeOf("arginfo_error_exception___construct")/b.SizeOf("struct _zend_internal_arg_info") - 1),
		ZEND_ACC_PUBLIC,
	},
	{
		"getSeverity",
