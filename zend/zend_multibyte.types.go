...
func (this *ZendMultibyteFunctions) SetEncodingFetcher(value ZendEncodingFetcher) {
	this.encoding_fetcher = value
}
func (this *ZendMultibyteFunctions) GetEncodingNameGetter() ZendEncodingNameGetter {
	return this.encoding_name_getter
}
func (this *ZendMultibyteFunctions) SetEncodingNameGetter(value ZendEncodingNameGetter) {
	this.encoding_name_getter = value
}
...
func (this *ZendMultibyteFunctions) SetLexerCompatibilityChecker(value ZendEncodingLexerCompatibilityChecker) {
	this.lexer_compatibility_checker = value
}
func (this *ZendMultibyteFunctions) GetEncodingDetector() ZendEncodingDetector {
	return this.encoding_detector
}
func (this *ZendMultibyteFunctions) SetEncodingDetector(value ZendEncodingDetector) {
	this.encoding_detector = value
}
func (this *ZendMultibyteFunctions) GetEncodingConverter() ZendEncodingConverter {
	return this.encoding_converter
}
func (this *ZendMultibyteFunctions) SetEncodingConverter(value ZendEncodingConverter) {
	this.encoding_converter = value
}
func (this *ZendMultibyteFunctions) GetEncodingListParser() ZendEncodingListParser {
	return this.encoding_list_parser
}
func (this *ZendMultibyteFunctions) SetEncodingListParser(value ZendEncodingListParser) {
	this.encoding_list_parser = value
}
...
func (this *ZendMultibyteFunctions) SetInternalEncodingGetter(value ZendEncodingInternalEncodingGetter) {
	this.internal_encoding_getter = value
}
...
func (this *ZendMultibyteFunctions) SetInternalEncodingSetter(value ZendEncodingInternalEncodingSetter) {
	this.internal_encoding_setter = value
}
