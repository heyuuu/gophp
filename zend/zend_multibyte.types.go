...
// func NewZendMultibyteFunctions(provider_name *byte, encoding_fetcher ZendEncodingFetcher, encoding_name_getter ZendEncodingNameGetter, lexer_compatibility_checker ZendEncodingLexerCompatibilityChecker, encoding_detector ZendEncodingDetector, encoding_converter ZendEncodingConverter, encoding_list_parser ZendEncodingListParser, internal_encoding_getter ZendEncodingInternalEncodingGetter, internal_encoding_setter ZendEncodingInternalEncodingSetter) *ZendMultibyteFunctions {
...
//     }
// }
// func MakeZendMultibyteFunctions(provider_name *byte, encoding_fetcher ZendEncodingFetcher, encoding_name_getter ZendEncodingNameGetter, lexer_compatibility_checker ZendEncodingLexerCompatibilityChecker, encoding_detector ZendEncodingDetector, encoding_converter ZendEncodingConverter, encoding_list_parser ZendEncodingListParser, internal_encoding_getter ZendEncodingInternalEncodingGetter, internal_encoding_setter ZendEncodingInternalEncodingSetter) ZendMultibyteFunctions {
//     return ZendMultibyteFunctions{
//         provider_name:provider_name,
//         encoding_fetcher:encoding_fetcher,
//         encoding_name_getter:encoding_name_getter,
