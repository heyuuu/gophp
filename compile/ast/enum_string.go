// Code generated by "stringer -linecomment -type=AssignOpKind,BinaryOpKind,UnaryOpKind,MagicConstKind,CastKind,InternalCallOp -output=enum_string.go"; DO NOT EDIT.
...
func _() {
	...
	_ = x[ICallEmpty-2]
	_ = x[ICallInclude-3]
	_ = x[ICallIncludeOnce-4]
	_ = x[ICallRequire-5]
	_ = x[ICallRequireOnce-6]
	_ = x[ICallEval-7]
}

const _InternalCallOp_name = "issetemptyincludeinclude_oncerequirerequire_onceeval"

var _InternalCallOp_index = [...]uint8{0, 5, 10, 17, 29, 36, 48, 52}

func (i InternalCallOp) String() string {
	i -= 1
	if i >= InternalCallOp(len(_InternalCallOp_index)-1) {
		return "InternalCallOp(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _InternalCallOp_name[_InternalCallOp_index[i]:_InternalCallOp_index[i+1]]
}
