...
type PhpCoreGlobals struct {
	implicit_flush              types2.ZendBool
	output_buffering            zend.ZendLong
	enable_dl                   types2.ZendBool
	output_handler              *byte
	unserialize_callback_func   *byte
	serialize_precision         zend.ZendLong
	memory_limit                zend.ZendLong
	max_input_time              zend.ZendLong
	track_errors                types2.ZendBool
	display_errors              types2.ZendBool
	display_startup_errors      types2.ZendBool
	log_errors                  types2.ZendBool
	log_errors_max_len          zend.ZendLong
	ignore_repeated_errors      types2.ZendBool
	ignore_repeated_source      types2.ZendBool
	report_memleaks             types2.ZendBool
	error_log                   *byte
	doc_root                    *byte
	user_dir                    *byte
	include_path                *byte
	...
	rfc1867_protected_variables types2.Array
	connection_status           int16
	ignore_user_abort           types2.ZendBool
	header_is_being_sent        uint8
	tick_functions              zend.ZendLlist
	http_globals                []types2.Zval
	expose_php                  types2.ZendBool
	register_argc_argv          types2.ZendBool
	auto_globals_jit            types2.ZendBool
	docref_root                 *byte
	docref_ext                  *byte
	html_errors                 types2.ZendBool
	xmlrpc_errors               types2.ZendBool
	xmlrpc_error_number         zend.ZendLong
	activated_auto_globals      []types2.ZendBool
	modules_activated           types2.ZendBool
	file_uploads                types2.ZendBool
	during_request_startup      types2.ZendBool
	allow_url_fopen             types2.ZendBool
	enable_post_data_reading    types2.ZendBool
	report_zend_debug           types2.ZendBool
	last_error_type             int
	...
	allow_url_include           types2.ZendBool
	max_input_nesting_level     zend.ZendLong
	max_input_vars              zend.ZendLong
	in_user_include             types2.ZendBool
	user_ini_filename           *byte
	user_ini_cache_ttl          zend.ZendLong
	request_order               *byte
	mail_x_header               types2.ZendBool
	mail_log                    *byte
	in_error_log                types2.ZendBool
	syslog_facility             zend.ZendLong
	syslog_ident                *byte
	have_called_openlog         types2.ZendBool
	syslog_filter               zend.ZendLong
}

func (this *PhpCoreGlobals) GetImplicitFlush() types2.ZendBool    { return this.implicit_flush }
func (this *PhpCoreGlobals) GetOutputBuffering() zend.ZendLong    { return this.output_buffering }
func (this *PhpCoreGlobals) GetEnableDl() types2.ZendBool         { return this.enable_dl }
...
func (this *PhpCoreGlobals) GetTrackErrors() types2.ZendBool      { return this.track_errors }
func (this *PhpCoreGlobals) GetDisplayErrors() types2.ZendBool    { return this.display_errors }
func (this *PhpCoreGlobals) GetDisplayStartupErrors() types2.ZendBool {
	return this.display_startup_errors
}
func (this *PhpCoreGlobals) GetLogErrors() types2.ZendBool     { return this.log_errors }
func (this *PhpCoreGlobals) GetLogErrorsMaxLen() zend.ZendLong { return this.log_errors_max_len }
func (this *PhpCoreGlobals) GetIgnoreRepeatedErrors() types2.ZendBool {
	return this.ignore_repeated_errors
}
func (this *PhpCoreGlobals) GetIgnoreRepeatedSource() types2.ZendBool {
	return this.ignore_repeated_source
}
func (this *PhpCoreGlobals) GetReportMemleaks() types2.ZendBool   { return this.report_memleaks }
...
func (this *PhpCoreGlobals) GetIgnoreUserAbort() types2.ZendBool  { return this.ignore_user_abort }
func (this *PhpCoreGlobals) GetExposePhp() types2.ZendBool        { return this.expose_php }
func (this *PhpCoreGlobals) GetRegisterArgcArgv() types2.ZendBool { return this.register_argc_argv }
func (this *PhpCoreGlobals) GetAutoGlobalsJit() types2.ZendBool   { return this.auto_globals_jit }
...
func (this *PhpCoreGlobals) GetHtmlErrors() types2.ZendBool       { return this.html_errors }
func (this *PhpCoreGlobals) GetXmlrpcErrors() types2.ZendBool     { return this.xmlrpc_errors }
func (this *PhpCoreGlobals) GetXmlrpcErrorNumber() zend.ZendLong  { return this.xmlrpc_error_number }
func (this *PhpCoreGlobals) GetFileUploads() types2.ZendBool      { return this.file_uploads }
func (this *PhpCoreGlobals) GetAllowUrlFopen() types2.ZendBool    { return this.allow_url_fopen }
func (this *PhpCoreGlobals) GetEnablePostDataReading() types2.ZendBool {
	return this.enable_post_data_reading
}
func (this *PhpCoreGlobals) GetReportZendDebug() types2.ZendBool { return this.report_zend_debug }
...
func (this *PhpCoreGlobals) GetAllowUrlInclude() types2.ZendBool { return this.allow_url_include }
...
func (this *PhpCoreGlobals) GetMailXHeader() types2.ZendBool   { return this.mail_x_header }
