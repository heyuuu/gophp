...
// func NewArgSeparators(output *byte, input *byte) *ArgSeparators {
...
// func NewPhpCoreGlobals(implicit_flush zend.ZendBool, output_buffering zend.ZendLong, enable_dl zend.ZendBool, output_handler *byte, unserialize_callback_func *byte, serialize_precision zend.ZendLong, memory_limit zend.ZendLong, max_input_time zend.ZendLong, track_errors zend.ZendBool, display_errors zend.ZendBool, display_startup_errors zend.ZendBool, log_errors zend.ZendBool, log_errors_max_len zend.ZendLong, ignore_repeated_errors zend.ZendBool, ignore_repeated_source zend.ZendBool, report_memleaks zend.ZendBool, error_log *byte, doc_root *byte, user_dir *byte, include_path *byte, open_basedir *byte, extension_dir *byte, php_binary *byte, sys_temp_dir *byte, upload_tmp_dir *byte, upload_max_filesize zend.ZendLong, error_append_string *byte, error_prepend_string *byte, auto_prepend_file *byte, auto_append_file *byte, input_encoding *byte, internal_encoding *byte, output_encoding *byte, arg_separator ArgSeparators, variables_order *byte, rfc1867_protected_variables zend.HashTable, connection_status short, ignore_user_abort zend.ZendBool, header_is_being_sent uint8, tick_functions zend.ZendLlist, http_globals []zend.Zval, expose_php zend.ZendBool, register_argc_argv zend.ZendBool, auto_globals_jit zend.ZendBool, docref_root *byte, docref_ext *byte, html_errors zend.ZendBool, xmlrpc_errors zend.ZendBool, xmlrpc_error_number zend.ZendLong, activated_auto_globals []zend.ZendBool, modules_activated zend.ZendBool, file_uploads zend.ZendBool, during_request_startup zend.ZendBool, allow_url_fopen zend.ZendBool, enable_post_data_reading zend.ZendBool, report_zend_debug zend.ZendBool, last_error_type int, last_error_message *byte, last_error_file *byte, last_error_lineno int, php_sys_temp_dir *byte, disable_functions *byte, disable_classes *byte, allow_url_include zend.ZendBool, max_input_nesting_level zend.ZendLong, max_input_vars zend.ZendLong, in_user_include zend.ZendBool, user_ini_filename *byte, user_ini_cache_ttl zend.ZendLong, request_order *byte, mail_x_header zend.ZendBool, mail_log *byte, in_error_log zend.ZendBool, syslog_facility zend.ZendLong, syslog_ident *byte, have_called_openlog zend.ZendBool, syslog_filter zend.ZendLong) *PhpCoreGlobals {
...
//     }
// }
// func MakePhpCoreGlobals(implicit_flush zend.ZendBool, output_buffering zend.ZendLong, enable_dl zend.ZendBool, output_handler *byte, unserialize_callback_func *byte, serialize_precision zend.ZendLong, memory_limit zend.ZendLong, max_input_time zend.ZendLong, track_errors zend.ZendBool, display_errors zend.ZendBool, display_startup_errors zend.ZendBool, log_errors zend.ZendBool, log_errors_max_len zend.ZendLong, ignore_repeated_errors zend.ZendBool, ignore_repeated_source zend.ZendBool, report_memleaks zend.ZendBool, error_log *byte, doc_root *byte, user_dir *byte, include_path *byte, open_basedir *byte, extension_dir *byte, php_binary *byte, sys_temp_dir *byte, upload_tmp_dir *byte, upload_max_filesize zend.ZendLong, error_append_string *byte, error_prepend_string *byte, auto_prepend_file *byte, auto_append_file *byte, input_encoding *byte, internal_encoding *byte, output_encoding *byte, arg_separator ArgSeparators, variables_order *byte, rfc1867_protected_variables zend.HashTable, connection_status short, ignore_user_abort zend.ZendBool, header_is_being_sent uint8, tick_functions zend.ZendLlist, http_globals []zend.Zval, expose_php zend.ZendBool, register_argc_argv zend.ZendBool, auto_globals_jit zend.ZendBool, docref_root *byte, docref_ext *byte, html_errors zend.ZendBool, xmlrpc_errors zend.ZendBool, xmlrpc_error_number zend.ZendLong, activated_auto_globals []zend.ZendBool, modules_activated zend.ZendBool, file_uploads zend.ZendBool, during_request_startup zend.ZendBool, allow_url_fopen zend.ZendBool, enable_post_data_reading zend.ZendBool, report_zend_debug zend.ZendBool, last_error_type int, last_error_message *byte, last_error_file *byte, last_error_lineno int, php_sys_temp_dir *byte, disable_functions *byte, disable_classes *byte, allow_url_include zend.ZendBool, max_input_nesting_level zend.ZendLong, max_input_vars zend.ZendLong, in_user_include zend.ZendBool, user_ini_filename *byte, user_ini_cache_ttl zend.ZendLong, request_order *byte, mail_x_header zend.ZendBool, mail_log *byte, in_error_log zend.ZendBool, syslog_facility zend.ZendLong, syslog_ident *byte, have_called_openlog zend.ZendBool, syslog_filter zend.ZendLong) PhpCoreGlobals {
//     return PhpCoreGlobals{
//         implicit_flush:implicit_flush,
//         output_buffering:output_buffering,
//         enable_dl:enable_dl,
