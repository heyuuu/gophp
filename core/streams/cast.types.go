...
// func NewCOOKIE_IO_FUNCTIONS_T(reader func(any, *byte, int) int, writer func(any, *byte, int) int, seeker func(any, PHP_FPOS_T, int) PHP_FPOS_T, closer func(any) int) *COOKIE_IO_FUNCTIONS_T {
...
// func (this *COOKIE_IO_FUNCTIONS_T) SetSeeker(value func(any, PHP_FPOS_T, int) PHP_FPOS_T) { this.seeker = value }
