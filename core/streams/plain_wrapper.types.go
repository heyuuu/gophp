...
func (this *PhpStdioStreamData) GetTempName() *types.String      { return this.temp_name }
func (this *PhpStdioStreamData) SetTempName(value *types.String) { this.temp_name = value }
