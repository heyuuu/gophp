...
type PhpStreamFilterOps struct {
	filter func(stream *core.PhpStream, thisfilter *core.PhpStreamFilter, buckets_in *PhpStreamBucketBrigade, buckets_out *PhpStreamBucketBrigade, bytes_consumed *int, flags int) PhpStreamFilterStatusT
