...
func ZmStartupUserStreams(type_ int, module_number int) int {
	...
	if LeProtocols == types.FAILURE {
		return types.FAILURE
	}
	zend.RegisterLongConstant("STREAM_USE_PATH", core.USE_PATH, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_IGNORE_URL", core.IGNORE_URL, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_REPORT_ERRORS", core.REPORT_ERRORS, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_MUST_SEEK", core.STREAM_MUST_SEEK, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_URL_STAT_LINK", core.PHP_STREAM_URL_STAT_LINK, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_URL_STAT_QUIET", core.PHP_STREAM_URL_STAT_QUIET, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_MKDIR_RECURSIVE", core.PHP_STREAM_MKDIR_RECURSIVE, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_IS_URL", core.PHP_STREAM_IS_URL, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_OPTION_BLOCKING", core.PHP_STREAM_OPTION_BLOCKING, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_OPTION_READ_TIMEOUT", core.PHP_STREAM_OPTION_READ_TIMEOUT, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_OPTION_READ_BUFFER", core.PHP_STREAM_OPTION_READ_BUFFER, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_OPTION_WRITE_BUFFER", core.PHP_STREAM_OPTION_WRITE_BUFFER, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_BUFFER_NONE", core.PHP_STREAM_BUFFER_NONE, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_BUFFER_LINE", core.PHP_STREAM_BUFFER_LINE, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_BUFFER_FULL", core.PHP_STREAM_BUFFER_FULL, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_CAST_AS_STREAM", core.PHP_STREAM_AS_STDIO, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_CAST_FOR_SELECT", core.PHP_STREAM_AS_FD_FOR_SELECT, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_TOUCH", core.PHP_STREAM_META_TOUCH, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_OWNER", core.PHP_STREAM_META_OWNER, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_OWNER_NAME", core.PHP_STREAM_META_OWNER_NAME, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_GROUP", core.PHP_STREAM_META_GROUP, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_GROUP_NAME", core.PHP_STREAM_META_GROUP_NAME, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
	zend.RegisterLongConstant("STREAM_META_ACCESS", core.PHP_STREAM_META_ACCESS, zend.CONST_CS|zend.CONST_PERSISTENT, module_number)
...
func UserWrapperOpener(
	...
	args[0].SetRawString(b.CastStrAuto(filename))
	args[1].SetRawString(b.CastStrAuto(mode))
	args[2].SetLong(options)
	args[3].SetNewRef(zend.EG__().GetUninitializedZval())
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_OPEN))
...
func UserWrapperOpendir(
	...
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_DIR_OPEN))
...
func ZifStreamWrapperRegister(executeData *zend.ZendExecuteData, return_value *types.Zval) {
	...
	if b.Assign(&(uwrap.GetCe()), zend.ZendLookupClass(classname)) != nil {
		if PhpRegisterUrlStreamWrapperVolatile(protocol, uwrap.GetWrapper()) == types.SUCCESS {
			...
			if types.ArrayStrExists(core.PhpStreamGetUrlStreamWrappersHash(), protocol.GetStr()) != 0 {
...
func PhpUserstreamopRead(stream *core.PhpStream, buf *byte, count int) ssize_t {
	...
	func_name.SetRawString(USERSTREAM_EOF)
...
func PhpUserstreamopSeek(stream *core.PhpStream, offset zend.ZendOffT, whence int, newoffs *zend.ZendOffT) int {
	...
	if call_result == types.FAILURE {
		...
		zend.ZvalPtrDtor(&retval)
		return -1
	} else if call_result == types.SUCCESS && retval.GetType() != types.IS_UNDEF && zend.ZvalIsTrue(&retval) != 0 {
		ret = 0
	} else {
		ret = -1
	}
	...
	func_name.SetRawString(USERSTREAM_TELL)
	call_result = zend.CallUserFunction(b.CondF2(us.GetObject().IsUndef(), nil, func() types.Zval { return us.GetObject() }), &func_name, &retval, 0, nil)
...
func PhpUserstreamopStat(stream *core.PhpStream, ssb *core.PhpStreamStatbuf) int {
	...
	var us *PhpUserstreamDataT = (*PhpUserstreamDataT)(stream.GetAbstract())
	var ret int = -1
	func_name.SetRawString(USERSTREAM_STAT)
	call_result = zend.CallUserFunction(b.CondF2(us.GetObject().IsUndef(), nil, func() types.Zval { return us.GetObject() }), &func_name, &retval, 0, nil)
...
func PhpUserstreamopSetOption(stream *core.PhpStream, option int, value int, ptrparam any) int {
	...
	case core.PHP_STREAM_OPTION_LOCKING:
		...
		func_name.SetRawString(USERSTREAM_LOCK)
		call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() types.Zval { return us.GetObject() }), &func_name, &retval, 1, args, 0)
		if call_result == types.SUCCESS && (retval.IsType(types.IS_FALSE) || retval.IsType(types.IS_TRUE)) {
	...
	case core.PHP_STREAM_OPTION_TRUNCATE_API:
		func_name.SetRawString(USERSTREAM_TRUNCATE)
		switch value {
	...
	case core.PHP_STREAM_OPTION_BLOCKING:
		func_name.SetRawString(USERSTREAM_SET_OPTION)
...
func UserWrapperUnlink(wrapper *core.PhpStreamWrapper, url *byte, options int, context *core.PhpStreamContext) int {
	...
	if object.IsType(types.IS_UNDEF) {
		return ret
	}

	/* call the unlink method */

	args[0].SetRawString(b.CastStrAuto(url))
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_UNLINK))
...
func UserWrapperRename(wrapper *core.PhpStreamWrapper, url_from *byte, url_to *byte, options int, context *core.PhpStreamContext) int {
	...
	args[0].SetRawString(b.CastStrAuto(url_from))
	args[1].SetRawString(b.CastStrAuto(url_to))
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_RENAME))
...
func UserWrapperMkdir(wrapper *core.PhpStreamWrapper, url *byte, mode int, options int, context *core.PhpStreamContext) int {
	...
	args[1].SetLong(mode)
	args[2].SetLong(options)
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_MKDIR))
...
func UserWrapperRmdir(wrapper *core.PhpStreamWrapper, url *byte, options int, context *core.PhpStreamContext) int {
	...
	args[0].SetRawString(b.CastStrAuto(url))
	args[1].SetLong(options)
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_RMDIR))
	call_result = zend.CallUserFunctionEx(&object, &zfuncname, &zretval, 2, args, 0)
	if call_result == types.SUCCESS && (zretval.IsType(types.IS_FALSE) || zretval.IsType(types.IS_TRUE)) {
		ret = zretval.IsType(types.IS_TRUE)
	} else if call_result == types.FAILURE {
...
func UserWrapperMetadata(wrapper *core.PhpStreamWrapper, url *byte, option int, value any, context *core.PhpStreamContext) int {
	...
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_METADATA))
	call_result = zend.CallUserFunctionEx(&object, &zfuncname, &zretval, 3, args, 0)
	if call_result == types.SUCCESS && (zretval.IsType(types.IS_FALSE) || zretval.IsType(types.IS_TRUE)) {
		ret = zretval.IsType(types.IS_TRUE)
	} else if call_result == types.FAILURE {
...
func UserWrapperStatUrl(wrapper *core.PhpStreamWrapper, url *byte, flags int, ssb *core.PhpStreamStatbuf, context *core.PhpStreamContext) int {
	...
	zfuncname.SetRawString(b.CastStrAuto(USERSTREAM_STATURL))
	call_result = zend.CallUserFunctionEx(&object, &zfuncname, &zretval, 2, args, 0)
...
func PhpUserstreamopReaddir(stream *core.PhpStream, buf *byte, count int) ssize_t {
	...
	func_name.SetRawString(USERSTREAM_DIR_READ)
	call_result = zend.CallUserFunction(b.CondF2(us.GetObject().IsUndef(), nil, func() types.Zval { return us.GetObject() }), &func_name, &retval, 0, nil)
...
func PhpUserstreamopRewinddir(stream *core.PhpStream, offset zend.ZendOffT, whence int, newoffs *zend.ZendOffT) int {
	...
	var retval types.Zval
	var us *PhpUserstreamDataT = (*PhpUserstreamDataT)(stream.GetAbstract())
	func_name.SetRawString(USERSTREAM_DIR_REWIND)
	zend.CallUserFunction(b.CondF2(us.GetObject().IsUndef(), nil, func() types.Zval { return us.GetObject() }), &func_name, &retval, 0, nil)
	zend.ZvalPtrDtor(&retval)
	zend.ZvalPtrDtor(&func_name)
	return 0
...
func PhpUserstreamopCast(stream *core.PhpStream, castas int, retptr *any) int {
	...
	func_name.SetRawString(USERSTREAM_CAST)
	switch castas {
