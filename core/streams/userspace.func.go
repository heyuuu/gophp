...
func UserWrapperOpener(
	...
	if zend.SETJMP(__bailout) == 0 {
		call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &zfuncname, &zretval, 4, args, 0)
	} else {
...
func UserWrapperOpendir(
	...
	call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &zfuncname, &zretval, 2, args, 0)
	if call_result == zend.SUCCESS && zretval.GetType() != zend.IS_UNDEF && zend.ZvalIsTrue(&zretval) != 0 {
...
func PhpUserstreamopWrite(stream *core.PhpStream, buf *byte, count int) ssize_t {
	...
	call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &func_name, &retval, 1, args, 0)
	zend.ZvalPtrDtor(&args[0])
...
func PhpUserstreamopClose(stream *core.PhpStream, close_handle int) int {
	...
	zend.CallUserFunction(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &func_name, &retval, 0, nil)
	zend.ZvalPtrDtor(&retval)
	zend.ZvalPtrDtor(&func_name)
	zend.ZvalPtrDtor(us.GetObject())
	us.GetObject().SetUndef()
...
func PhpUserstreamopSeek(stream *core.PhpStream, offset zend.ZendOffT, whence int, newoffs *zend.ZendOffT) int {
	...
	call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &func_name, &retval, 2, args, 0)
	zend.ZvalPtrDtor(&args[0])
	zend.ZvalPtrDtor(&args[1])
	zend.ZvalPtrDtor(&func_name)
	if call_result == zend.FAILURE {
...
func PhpUserstreamopSetOption(stream *core.PhpStream, option int, value int, ptrparam any) int {
	...
	case core.PHP_STREAM_OPTION_BLOCKING:
		...
		call_result = zend.CallUserFunctionEx(b.CondF2(us.GetObject().IsUndef(), nil, func() zend.Zval { return us.GetObject() }), &func_name, &retval, 3, args, 0)
		if call_result == zend.FAILURE {
