...
func OnUpdateDisplayErrors(
	...
	PG(display_errors) = types.ZendBool(PhpGetDisplayErrorsMode(new_value.GetVal(), new_value.GetLen()))
	return types.SUCCESS
}
...
func PhpVerror(docref *byte, params *byte, type_ int, format *byte, args ...any) {
	...
	if PG(track_errors) && ModuleInitialized != 0 && zend.EG__().GetActive() != 0 && (zend.EG__().GetUserErrorHandler().IsType(types.IS_UNDEF) || (zend.EG__().GetUserErrorHandlerErrorReporting()&type_) == 0) {
		var tmp types.Zval
...
func PhpModuleStartup(sf ISapiModule, additional_modules *zend.ZendModuleEntry, num_additional_modules uint32) int {
	...
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_VERSION", PHP_VERSION, zend.CONST_PERSISTENT|zend.CONST_CS)
	...
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_EXTRA_VERSION", PHP_EXTRA_VERSION, zend.CONST_PERSISTENT|zend.CONST_CS)
	...
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_EXTENSION_DIR", PHP_EXTENSION_DIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_PREFIX", PHP_PREFIX, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_BINDIR", PHP_BINDIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_MANDIR", PHP_MANDIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_LIBDIR", PHP_LIBDIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_DATADIR", PHP_DATADIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_SYSCONFDIR", PHP_SYSCONFDIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_LOCALSTATEDIR", PHP_LOCALSTATEDIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_CONFIG_FILE_PATH", PHP_CONFIG_FILE_PATH, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_CONFIG_FILE_SCAN_DIR", PHP_CONFIG_FILE_SCAN_DIR, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_SHLIB_SUFFIX", PHP_SHLIB_SUFFIX, zend.CONST_PERSISTENT|zend.CONST_CS)
	zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_EOL", PHP_EOL, zend.CONST_PERSISTENT|zend.CONST_CS)
	...
	PhpBinaryInit()
	if PG(php_binary) {
		zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_BINARY", PG(php_binary), zend.CONST_PERSISTENT|zend.CONST_CS|zend.CONST_NO_FILE_CACHE)
	} else {
		zend.REGISTER_MAIN_STRINGL_CONSTANT("PHP_BINARY", "", zend.CONST_PERSISTENT|zend.CONST_CS|zend.CONST_NO_FILE_CACHE)
	}
