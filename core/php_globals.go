...
func (pg *PhpCoreGlobals) GetOutputBuffering() int           { return pg.output_buffering }
...
func (pg *PhpCoreGlobals) GetSerializePrecision() int        { return pg.serialize_precision }
func (pg *PhpCoreGlobals) GetMaxInputTime() int              { return pg.max_input_time }
...
func (pg *PhpCoreGlobals) GetLogErrorsMaxLen() int { return pg.log_errors_max_len }
...
func (pg *PhpCoreGlobals) GetUploadMaxFilesize() int      { return pg.upload_max_filesize }
...
func (pg *PhpCoreGlobals) GetXmlrpcErrorNumber() int      { return pg.xmlrpc_error_number }
...
func (pg *PhpCoreGlobals) GetMaxInputNestingLevel() int {
	return pg.max_input_nesting_level
}
func (pg *PhpCoreGlobals) GetMaxInputVars() int      { return pg.max_input_vars }
func (pg *PhpCoreGlobals) GetUserIniFilename() *byte { return pg.user_ini_filename }
func (pg *PhpCoreGlobals) GetUserIniCacheTtl() int   { return pg.user_ini_cache_ttl }
...
func (pg *PhpCoreGlobals) GetSyslogFacility() int    { return pg.syslog_facility }
func (pg *PhpCoreGlobals) GetSyslogIdent() *byte     { return pg.syslog_ident }
func (pg *PhpCoreGlobals) GetSyslogFilter() int      { return pg.syslog_filter }
