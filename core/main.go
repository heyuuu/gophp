...
var IniEntries []zend.ZendIniEntryDef = []zend.ZendIniEntryDef{{"highlight.comment", nil, nil, nil, nil, "#FF8000", zend.ZendIniColorDisplayerCb, g.SizeOf("\"#FF8000\"") - 1, g.SizeOf("\"highlight.comment\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"highlight.default", nil, nil, nil, nil, "#0000BB", zend.ZendIniColorDisplayerCb, g.SizeOf("\"#0000BB\"") - 1, g.SizeOf("\"highlight.default\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"highlight.html", nil, nil, nil, nil, "#000000", zend.ZendIniColorDisplayerCb, g.SizeOf("\"#000000\"") - 1, g.SizeOf("\"highlight.html\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"highlight.keyword", nil, nil, nil, nil, "#007700", zend.ZendIniColorDisplayerCb, g.SizeOf("\"#007700\"") - 1, g.SizeOf("\"highlight.keyword\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"highlight.string", nil, nil, nil, nil, "#DD0000", zend.ZendIniColorDisplayerCb, g.SizeOf("\"#DD0000\"") - 1, g.SizeOf("\"highlight.string\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"display_errors", OnUpdateDisplayErrors, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetDisplayErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", DisplayErrorsMode, g.SizeOf("\"1\"") - 1, g.SizeOf("\"display_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"display_startup_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetDisplayStartupErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"display_startup_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"enable_dl", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetEnableDl())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"enable_dl\"") - 1, 1 << 2}, {"expose_php", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetExposePhp())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"expose_php\"") - 1, 1 << 2}, {"docref_root", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetDocrefRoot())) - (*byte)(nil))), any(&CoreGlobals), nil, "", nil, g.SizeOf("\"\"") - 1, g.SizeOf("\"docref_root\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"docref_ext", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetDocrefExt())) - (*byte)(nil))), any(&CoreGlobals), nil, "", nil, g.SizeOf("\"\"") - 1, g.SizeOf("\"docref_ext\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"html_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetHtmlErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"html_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"xmlrpc_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetXmlrpcErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"xmlrpc_errors\"") - 1, 1 << 2}, {"xmlrpc_error_number", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetXmlrpcErrorNumber())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", nil, g.SizeOf("\"0\"") - 1, g.SizeOf("\"xmlrpc_error_number\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"max_input_time", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetMaxInputTime())) - (*byte)(nil))), any(&CoreGlobals), nil, "-1", nil, g.SizeOf("\"-1\"") - 1, g.SizeOf("\"max_input_time\"") - 1, 1<<2 | 1<<1}, {"ignore_user_abort", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetIgnoreUserAbort())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"ignore_user_abort\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"implicit_flush", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetImplicitFlush())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"implicit_flush\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"log_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetLogErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"log_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"log_errors_max_len", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetLogErrorsMaxLen())) - (*byte)(nil))), any(&CoreGlobals), nil, "1024", nil, g.SizeOf("\"1024\"") - 1, g.SizeOf("\"log_errors_max_len\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"ignore_repeated_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetIgnoreRepeatedErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"ignore_repeated_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"ignore_repeated_source", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetIgnoreRepeatedSource())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"ignore_repeated_source\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"report_memleaks", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetReportMemleaks())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"report_memleaks\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"report_zend_debug", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetReportZendDebug())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"report_zend_debug\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"output_buffering", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetOutputBuffering())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", nil, g.SizeOf("\"0\"") - 1, g.SizeOf("\"output_buffering\"") - 1, 1<<1 | 1<<2}, {"output_handler", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetOutputHandler())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"output_handler\"") - 1, 1<<1 | 1<<2}, {"register_argc_argv", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetRegisterArgcArgv())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"register_argc_argv\"") - 1, 1<<1 | 1<<2}, {"auto_globals_jit", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetAutoGlobalsJit())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"auto_globals_jit\"") - 1, 1<<1 | 1<<2}, {"short_open_tag", zend.OnUpdateBool, any(zend_long((*byte)(&((*zend.ZendCompilerGlobals)(nil).short_tags)) - (*byte)(nil))), any(&zend.CompilerGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"short_open_tag\"") - 1, 1<<2 | 1<<1}, {"track_errors", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetTrackErrors())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"track_errors\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"unserialize_callback_func", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUnserializeCallbackFunc())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"unserialize_callback_func\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"serialize_precision", OnSetSerializePrecision, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetSerializePrecision())) - (*byte)(nil))), any(&CoreGlobals), nil, "-1", nil, g.SizeOf("\"-1\"") - 1, g.SizeOf("\"serialize_precision\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"arg_separator.output", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetArgSeparator().GetOutput())) - (*byte)(nil))), any(&CoreGlobals), nil, "&", nil, g.SizeOf("\"&\"") - 1, g.SizeOf("\"arg_separator.output\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"arg_separator.input", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetArgSeparator().GetInput())) - (*byte)(nil))), any(&CoreGlobals), nil, "&", nil, g.SizeOf("\"&\"") - 1, g.SizeOf("\"arg_separator.input\"") - 1, 1<<2 | 1<<1}, {"auto_append_file", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetAutoAppendFile())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"auto_append_file\"") - 1, 1<<2 | 1<<1}, {"auto_prepend_file", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetAutoPrependFile())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"auto_prepend_file\"") - 1, 1<<2 | 1<<1}, {"doc_root", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetDocRoot())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"doc_root\"") - 1, 1 << 2}, {"default_charset", OnUpdateDefaultCharset, any(zend_long((*byte)(&((*sapi_globals_struct)(nil).GetDefaultCharset())) - (*byte)(nil))), any(&sapi_globals), nil, "UTF-8", nil, g.SizeOf("\"UTF-8\"") - 1, g.SizeOf("\"default_charset\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"default_mimetype", OnUpdateDefaultMimeTye, any(zend_long((*byte)(&((*sapi_globals_struct)(nil).GetDefaultMimetype())) - (*byte)(nil))), any(&sapi_globals), nil, "text/html", nil, g.SizeOf("\"text/html\"") - 1, g.SizeOf("\"default_mimetype\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"internal_encoding", OnUpdateInternalEncoding, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetInternalEncoding())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"internal_encoding\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"input_encoding", OnUpdateInputEncoding, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetInputEncoding())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"input_encoding\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"output_encoding", OnUpdateOutputEncoding, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetOutputEncoding())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"output_encoding\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"error_log", OnUpdateErrorLog, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetErrorLog())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"error_log\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"extension_dir", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetExtensionDir())) - (*byte)(nil))), any(&CoreGlobals), nil, "/usr/local/lib/php/extensions/no-debug-non-zts-20190902", nil, g.SizeOf("\"/usr/local/lib/php/extensions/no-debug-non-zts-20190902\"") - 1, g.SizeOf("\"extension_dir\"") - 1, 1 << 2}, {"sys_temp_dir", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetSysTempDir())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"sys_temp_dir\"") - 1, 1 << 2}, {"include_path", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetIncludePath())) - (*byte)(nil))), any(&CoreGlobals), nil, ".:", nil, g.SizeOf("\".:\"") - 1, g.SizeOf("\"include_path\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"max_execution_time", OnUpdateTimeout, nil, nil, nil, "30", nil, g.SizeOf("\"30\"") - 1, g.SizeOf("\"max_execution_time\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"open_basedir", OnUpdateBaseDir, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetOpenBasedir())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"open_basedir\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"file_uploads", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetFileUploads())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"file_uploads\"") - 1, 1 << 2}, {"upload_max_filesize", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUploadMaxFilesize())) - (*byte)(nil))), any(&CoreGlobals), nil, "2M", nil, g.SizeOf("\"2M\"") - 1, g.SizeOf("\"upload_max_filesize\"") - 1, 1<<2 | 1<<1}, {"post_max_size", zend.OnUpdateLong, any(zend_long((*byte)(&((*sapi_globals_struct)(nil).GetPostMaxSize())) - (*byte)(nil))), any(&sapi_globals), nil, "8M", nil, g.SizeOf("\"8M\"") - 1, g.SizeOf("\"post_max_size\"") - 1, 1<<2 | 1<<1}, {"upload_tmp_dir", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUploadTmpDir())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"upload_tmp_dir\"") - 1, 1 << 2}, {"max_input_nesting_level", zend.OnUpdateLongGEZero, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetMaxInputNestingLevel())) - (*byte)(nil))), any(&CoreGlobals), nil, "64", nil, g.SizeOf("\"64\"") - 1, g.SizeOf("\"max_input_nesting_level\"") - 1, 1<<2 | 1<<1}, {"max_input_vars", zend.OnUpdateLongGEZero, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetMaxInputVars())) - (*byte)(nil))), any(&CoreGlobals), nil, "1000", nil, g.SizeOf("\"1000\"") - 1, g.SizeOf("\"max_input_vars\"") - 1, 1<<2 | 1<<1}, {"user_dir", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUserDir())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"user_dir\"") - 1, 1 << 2}, {"variables_order", zend.OnUpdateStringUnempty, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetVariablesOrder())) - (*byte)(nil))), any(&CoreGlobals), nil, "EGPCS", nil, g.SizeOf("\"EGPCS\"") - 1, g.SizeOf("\"variables_order\"") - 1, 1<<2 | 1<<1}, {"request_order", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetRequestOrder())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"request_order\"") - 1, 1<<2 | 1<<1}, {"error_append_string", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetErrorAppendString())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"error_append_string\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"error_prepend_string", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetErrorPrependString())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"error_prepend_string\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"SMTP", nil, nil, nil, nil, "localhost", nil, g.SizeOf("\"localhost\"") - 1, g.SizeOf("\"SMTP\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"smtp_port", nil, nil, nil, nil, "25", nil, g.SizeOf("\"25\"") - 1, g.SizeOf("\"smtp_port\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"mail.add_x_header", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetMailXHeader())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"mail.add_x_header\"") - 1, 1<<2 | 1<<1}, {"mail.log", OnUpdateMailLog, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetMailLog())) - (*byte)(nil))), any(&CoreGlobals), nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"mail.log\"") - 1, 1<<2 | 1<<1}, {"browscap", OnChangeBrowscap, nil, nil, nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"browscap\"") - 1, 1 << 2}, {"memory_limit", OnChangeMemoryLimit, nil, nil, nil, "128M", nil, g.SizeOf("\"128M\"") - 1, g.SizeOf("\"memory_limit\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"precision", OnSetPrecision, nil, nil, nil, "14", nil, g.SizeOf("\"14\"") - 1, g.SizeOf("\"precision\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"sendmail_from", nil, nil, nil, nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"sendmail_from\"") - 1, 1<<0 | 1<<1 | 1<<2}, {"sendmail_path", nil, nil, nil, nil, "/usr/sbin/sendmail" + " -t -i", nil, g.SizeOf("\"/usr/sbin/sendmail\" \" -t -i\"") - 1, g.SizeOf("\"sendmail_path\"") - 1, 1 << 2}, {"mail.force_extra_parameters", OnChangeMailForceExtra, nil, nil, nil, nil, nil, g.SizeOf("NULL") - 1, g.SizeOf("\"mail.force_extra_parameters\"") - 1, 1<<2 | 1<<1}, {"disable_functions", nil, nil, nil, nil, "", nil, g.SizeOf("\"\"") - 1, g.SizeOf("\"disable_functions\"") - 1, 1 << 2}, {"disable_classes", nil, nil, nil, nil, "", nil, g.SizeOf("\"\"") - 1, g.SizeOf("\"disable_classes\"") - 1, 1 << 2}, {"max_file_uploads", nil, nil, nil, nil, "20", nil, g.SizeOf("\"20\"") - 1, g.SizeOf("\"max_file_uploads\"") - 1, 1<<2 | 1<<1}, {"allow_url_fopen", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetAllowUrlFopen())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"allow_url_fopen\"") - 1, 1 << 2}, {"allow_url_include", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetAllowUrlInclude())) - (*byte)(nil))), any(&CoreGlobals), nil, "0", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"0\"") - 1, g.SizeOf("\"allow_url_include\"") - 1, 1 << 2}, {"enable_post_data_reading", zend.OnUpdateBool, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetEnablePostDataReading())) - (*byte)(nil))), any(&CoreGlobals), nil, "1", zend.ZendIniBooleanDisplayerCb, g.SizeOf("\"1\"") - 1, g.SizeOf("\"enable_post_data_reading\"") - 1, 1<<2 | 1<<1}, {"realpath_cache_size", zend.OnUpdateLong, any(zend_long((*byte)(&((*zend.VirtualCwdGlobals)(nil).realpath_cache_size_limit)) - (*byte)(nil))), any(&zend.CwdGlobals), nil, "4096K", nil, g.SizeOf("\"4096K\"") - 1, g.SizeOf("\"realpath_cache_size\"") - 1, 1 << 2}, {"realpath_cache_ttl", zend.OnUpdateLong, any(zend_long((*byte)(&((*zend.VirtualCwdGlobals)(nil).realpath_cache_ttl)) - (*byte)(nil))), any(&zend.CwdGlobals), nil, "120", nil, g.SizeOf("\"120\"") - 1, g.SizeOf("\"realpath_cache_ttl\"") - 1, 1 << 2}, {"user_ini.filename", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUserIniFilename())) - (*byte)(nil))), any(&CoreGlobals), nil, ".user.ini", nil, g.SizeOf("\".user.ini\"") - 1, g.SizeOf("\"user_ini.filename\"") - 1, 1 << 2}, {"user_ini.cache_ttl", zend.OnUpdateLong, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetUserIniCacheTtl())) - (*byte)(nil))), any(&CoreGlobals), nil, "300", nil, g.SizeOf("\"300\"") - 1, g.SizeOf("\"user_ini.cache_ttl\"") - 1, 1 << 2}, {"hard_timeout", zend.OnUpdateLong, any(zend_long((*byte)(&((*zend.ZendExecutorGlobals)(nil).hard_timeout)) - (*byte)(nil))), any(&zend.ExecutorGlobals), nil, "2", nil, g.SizeOf("\"2\"") - 1, g.SizeOf("\"hard_timeout\"") - 1, 1 << 2}, {"syslog.facility", OnSetFacility, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetSyslogFacility())) - (*byte)(nil))), any(&CoreGlobals), nil, "LOG_USER", nil, g.SizeOf("\"LOG_USER\"") - 1, g.SizeOf("\"syslog.facility\"") - 1, 1 << 2}, {"syslog.ident", zend.OnUpdateString, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetSyslogIdent())) - (*byte)(nil))), any(&CoreGlobals), nil, "php", nil, g.SizeOf("\"php\"") - 1, g.SizeOf("\"syslog.ident\"") - 1, 1 << 2}, {"syslog.filter", OnSetLogFilter, any(zend_long((*byte)(&((*PhpCoreGlobals)(nil).GetSyslogFilter())) - (*byte)(nil))), any(&CoreGlobals), nil, "no-ctrl", nil, g.SizeOf("\"no-ctrl\"") - 1, g.SizeOf("\"syslog.filter\"") - 1, 1<<0 | 1<<1 | 1<<2}, {nil, nil, nil, nil, nil, nil, nil, 0, 0, 0}}
...
func PhpVerror(docref *byte, params *byte, type_ int, format *byte, args va_list) {
...
func PhpErrorCb(type_ int, error_filename *byte, error_lineno uint32, format *byte, args va_list) {
	var buffer *byte
	var buffer_len int
	var display int
...
func PhpModuleStartup(sf *sapi_module_struct, additional_modules *zend.ZendModuleEntry, num_additional_modules uint32) int {
	...
	*/
	...
	var directives []struct {
		...
		phrase      *byte
		directives  []*byte
	}{{1 << 13, "Directive '%s' is deprecated", {"track_errors", "allow_url_include", nil}}, {1 << 4, "Directive '%s' is no longer available in PHP", {"allow_call_time_pass_reference", "asp_tags", "define_syslog_variables", "highlight.bg", "magic_quotes_gpc", "magic_quotes_runtime", "magic_quotes_sybase", "register_globals", "register_long_arrays", "safe_mode", "safe_mode_gid", "safe_mode_include_dir", "safe_mode_exec_dir", "safe_mode_allowed_env_vars", "safe_mode_protected_env_vars", "zend.ze1_compatibility_mode", nil}}}
	var i uint
	var __orig_bailout *sigjmp_buf = zend.EG.bailout
	var __bailout sigjmp_buf
	zend.EG.bailout = &__bailout
