...
// func NewPhpStreamStatbuf(sb zend.ZendStatT) *PhpStreamStatbuf {
...
// func NewPhpStreamDirent(d_name []byte) *PhpStreamDirent {
...
// func (this *PhpStreamWrapperOps) SetStreamOpener(value func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream) { this.stream_opener = value }
...
// func (this *PhpStreamWrapperOps) SetDirOpener(value func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream) { this.dir_opener = value }
...
// func NewPhpStreamWrapper(wops *PhpStreamWrapperOps, abstract any, is_url int) *PhpStreamWrapper {
...
// func NewPhpStream(ops *PhpStreamOps, abstract any, readfilters streams.PhpStreamFilterChain, writefilters streams.PhpStreamFilterChain, wrapper *PhpStreamWrapper, wrapperthis any, wrapperdata zend.Zval, is_persistent uint8, in_free uint8, eof uint8, __exposed uint8, fclose_stdiocast uint8, fgetss_state uint8, mode []byte, flags uint32, res *zend.ZendResource, stdiocast *r.FILE, orig_path *byte, ctx *zend.ZendResource, position zend.ZendOffT, readbuf *uint8, readbuflen int, readpos zend.ZendOffT, writepos zend.ZendOffT, chunk_size int, enclosing_stream *PhpStream) *PhpStream {
//     return &PhpStream{
//         ops:ops,
//         abstract:abstract,
...
//     }
// }
// func MakePhpStream(ops *PhpStreamOps, abstract any, readfilters streams.PhpStreamFilterChain, writefilters streams.PhpStreamFilterChain, wrapper *PhpStreamWrapper, wrapperthis any, wrapperdata zend.Zval, is_persistent uint8, in_free uint8, eof uint8, __exposed uint8, fclose_stdiocast uint8, fgetss_state uint8, mode []byte, flags uint32, res *zend.ZendResource, stdiocast *r.FILE, orig_path *byte, ctx *zend.ZendResource, position zend.ZendOffT, readbuf *uint8, readbuflen int, readpos zend.ZendOffT, writepos zend.ZendOffT, chunk_size int, enclosing_stream *PhpStream) PhpStream {
//     return PhpStream{
//         ops:ops,
//         abstract:abstract,
//         readfilters:readfilters,
