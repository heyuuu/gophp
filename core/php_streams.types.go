...
func (this *PhpStreamOps) SetWrite(value func(stream *PhpStream, buf *byte, count int) ssize_t) {
	this.write = value
}
func (this PhpStreamOps) GetRead() func(stream *PhpStream, buf *byte, count int) ssize_t {
	return this.read
}
func (this *PhpStreamOps) SetRead(value func(stream *PhpStream, buf *byte, count int) ssize_t) {
	this.read = value
}
func (this PhpStreamOps) GetClose() func(stream *PhpStream, close_handle int) int { return this.close }
func (this *PhpStreamOps) SetClose(value func(stream *PhpStream, close_handle int) int) {
	this.close = value
}
...
func (this *PhpStreamOps) SetSeek(value func(stream *PhpStream, offset zend.ZendOffT, whence int, newoffset *zend.ZendOffT) int) {
	this.seek = value
}
func (this PhpStreamOps) GetCast() func(stream *PhpStream, castas int, ret *any) int {
	return this.cast
}
func (this *PhpStreamOps) SetCast(value func(stream *PhpStream, castas int, ret *any) int) {
	this.cast = value
}
func (this PhpStreamOps) GetStat() func(stream *PhpStream, ssb *PhpStreamStatbuf) int {
	return this.stat
}
func (this *PhpStreamOps) SetStat(value func(stream *PhpStream, ssb *PhpStreamStatbuf) int) {
	this.stat = value
}
func (this PhpStreamOps) GetSetOption() func(stream *PhpStream, option int, value int, ptrparam any) int {
	return this.set_option
}
func (this *PhpStreamOps) SetSetOption(value func(stream *PhpStream, option int, value int, ptrparam any) int) {
...
type PhpStreamWrapperOps struct {
	stream_opener   func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream
	...
	dir_opener      func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream
	label           *byte
...
func (this *PhpStreamWrapperOps) SetStreamOpener(value func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream) {
...
func (this *PhpStreamWrapperOps) SetStreamCloser(value func(wrapper *PhpStreamWrapper, stream *PhpStream) int) {
	this.stream_closer = value
}
func (this PhpStreamWrapperOps) GetStreamStat() func(wrapper *PhpStreamWrapper, stream *PhpStream, ssb *PhpStreamStatbuf) int {
	return this.stream_stat
}
func (this *PhpStreamWrapperOps) SetStreamStat(value func(wrapper *PhpStreamWrapper, stream *PhpStream, ssb *PhpStreamStatbuf) int) {
	this.stream_stat = value
}
...
func (this *PhpStreamWrapperOps) SetUrlStat(value func(wrapper *PhpStreamWrapper, url *byte, flags int, ssb *PhpStreamStatbuf, context *PhpStreamContext) int) {
	this.url_stat = value
}
func (this PhpStreamWrapperOps) GetDirOpener() func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream {
	return this.dir_opener
}
func (this *PhpStreamWrapperOps) SetDirOpener(value func(wrapper *PhpStreamWrapper, filename *byte, mode *byte, options int, opened_path **zend.ZendString, context *PhpStreamContext) *PhpStream) {
...
func (this *PhpStreamWrapperOps) SetUnlink(value func(wrapper *PhpStreamWrapper, url *byte, options int, context *PhpStreamContext) int) {
	this.unlink = value
}
...
func (this *PhpStreamWrapperOps) SetRename(value func(wrapper *PhpStreamWrapper, url_from *byte, url_to *byte, options int, context *PhpStreamContext) int) {
	this.rename = value
}
...
func (this *PhpStreamWrapperOps) SetStreamMkdir(value func(wrapper *PhpStreamWrapper, url *byte, mode int, options int, context *PhpStreamContext) int) {
	this.stream_mkdir = value
}
...
func (this *PhpStreamWrapperOps) SetStreamRmdir(value func(wrapper *PhpStreamWrapper, url *byte, options int, context *PhpStreamContext) int) {
	this.stream_rmdir = value
}
...
func (this *PhpStreamWrapperOps) SetStreamMetadata(value func(wrapper *PhpStreamWrapper, url *byte, options int, value any, context *PhpStreamContext) int) {
	this.stream_metadata = value
}
