...
func (this *PhpStreamOps)  GetWrite() func(stream *PhpStream, buf *byte, count int) ssize_t      { return this.write }
// func (this *PhpStreamOps) SetWrite(value func(stream *PhpStream, buf *byte, count int) ssize_t) { this.write = value }
func (this *PhpStreamOps)  GetRead() func(stream *PhpStream, buf *byte, count int) ssize_t      { return this.read }
...
func (this *PhpStreamOps)  GetSeek() func(stream *PhpStream, offset zend.ZendOffT, whence int, newoffset *zend.ZendOffT) int      { return this.seek }
...
func (this *PhpStreamOps)  GetCast() func(stream *PhpStream, castas int, ret *any) int      { return this.cast }
// func (this *PhpStreamOps) SetCast(value func(stream *PhpStream, castas int, ret *any) int) { this.cast = value }
func (this *PhpStreamOps)  GetStat() func(stream *PhpStream, ssb *PhpStreamStatbuf) int      { return this.stat }
// func (this *PhpStreamOps) SetStat(value func(stream *PhpStream, ssb *PhpStreamStatbuf) int) { this.stat = value }
func (this *PhpStreamOps)  GetSetOption() func(stream *PhpStream, option int, value int, ptrparam any) int      { return this.set_option }
...
opened_path **zend.ZendString, 
context *PhpStreamContext, 
) *PhpStream      { return this.stream_opener }
...
opened_path **zend.ZendString, 
context *PhpStreamContext, 
) *PhpStream) { this.stream_opener = value }
func (this *PhpStreamWrapperOps)  GetStreamCloser() func(wrapper *PhpStreamWrapper, stream *PhpStream) int      { return this.stream_closer }
...
func (this *PhpStreamWrapperOps)  GetStreamStat() func(wrapper *PhpStreamWrapper, stream *PhpStream, ssb *PhpStreamStatbuf) int      { return this.stream_stat }
...
func (this *PhpStreamWrapperOps)  GetUrlStat() func(wrapper *PhpStreamWrapper, url *byte, flags int, ssb *PhpStreamStatbuf, context *PhpStreamContext) int      { return this.url_stat }
...
opened_path **zend.ZendString, 
context *PhpStreamContext, 
) *PhpStream      { return this.dir_opener }
...
opened_path **zend.ZendString, 
context *PhpStreamContext, 
) *PhpStream) { this.dir_opener = value }
...
func (this *PhpStreamWrapperOps)  GetUnlink() func(wrapper *PhpStreamWrapper, url *byte, options int, context *PhpStreamContext) int      { return this.unlink }
...
func (this *PhpStreamWrapperOps)  GetRename() func(wrapper *PhpStreamWrapper, url_from *byte, url_to *byte, options int, context *PhpStreamContext) int      { return this.rename }
...
func (this *PhpStreamWrapperOps)  GetStreamMkdir() func(wrapper *PhpStreamWrapper, url *byte, mode int, options int, context *PhpStreamContext) int      { return this.stream_mkdir }
...
func (this *PhpStreamWrapperOps)  GetStreamRmdir() func(wrapper *PhpStreamWrapper, url *byte, options int, context *PhpStreamContext) int      { return this.stream_rmdir }
...
func (this *PhpStreamWrapperOps)  GetStreamMetadata() func(wrapper *PhpStreamWrapper, url *byte, options int, value any, context *PhpStreamContext) int      { return this.stream_metadata }
...
if cond { this.AddFlags(value) } else { this.SubFlags(value) }
}
func (this PhpStream) IsAvoidBlocking() bool { return this.HasFlags(PHP_STREAM_FLAG_AVOID_BLOCKING) }
func (this *PhpStream) SetIsAvoidBlocking(cond bool) { this.SwitchFlags(PHP_STREAM_FLAG_AVOID_BLOCKING, cond) }
