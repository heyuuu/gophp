...
// #define php_stream_from_zval(xstr,pzval) do { if ( ( ( xstr ) = ( php_stream * ) zend_fetch_resource2_ex ( ( pzval ) , "stream" , php_file_le_stream ( ) , php_file_le_pstream ( ) ) ) == NULL ) { RETURN_FALSE ; } } while ( 0 )

// #define php_stream_from_res(xstr,res) do { if ( ( ( xstr ) = ( php_stream * ) zend_fetch_resource2 ( ( res ) , "stream" , php_file_le_stream ( ) , php_file_le_pstream ( ) ) ) == NULL ) { RETURN_FALSE ; } } while ( 0 )
