...
type ZendFcallInfoCache struct {
	function_handler IFunction
	calling_scope    *ClassEntry
	called_scope     *ClassEntry
	object           *ZendObject
}

func MakeZendFcallInfoCache(function_handler IFunction, calling_scope *ClassEntry, called_scope *ClassEntry, object *ZendObject) ZendFcallInfoCache {
...
func (this *ZendFcallInfoCache) GetFunctionHandler() IFunction { return this.function_handler }
func (this *ZendFcallInfoCache) SetFunctionHandler(value IFunction) {
